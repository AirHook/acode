					    ...
					    <div class="row">
					       ...
					       <div class="col-sm-12">
							...
							<div class="panel-heading"> 
								...
								<?php lang('heading_receipt_voucher'); ?>
							  ...
							  <div class="panel panel-body">
					          	 ...
					          	 <span>
					                ...
					                <?php if(isset($model['id'])) { ?>
					               	...
					               	<form action="<?php echo base_url('accounting/Transactions/receiptVocher') ."/". $model['id']?>" method="POST" role="form">

					               <?php } else{ ?>

					               	<form action="<?php echo base_url('accounting/Transactions/receiptVocher') ?>" method="POST" role="form">
										...
										<div class="row">
													...
													<div class="col-sm-4">
														...
														<div class="input-right form-group">
															...
															<input required="" type="text" readonly="" name="voucherNo" class="form-control" value="RV-<?php echo isset($next_type) ? sprintf('%05d', $next_type) : '00001'; ?>">
														...
														<div class="input-right form-group">
															...
															<select required="" class="form-control select2 " name="main_ledger_id">
																...
																if(!empty($cashBank)){
																	...
																	<option value="<?php echo isset($bankAccountCash->id) ? $bankAccountCash->id :''; ?>">
													...
													<div class="col-sm-4">
														...
														<div class="input-right-box form-group">
															...
															<div class="form-group ">
																...
																<div class="input-group calendar">
																	...
																	<input required="" readonly="" type="text" name="date" class="form-control <?php echo ($controller->has_access_of('edit_date_receipt_voucher')) ? 'datepicker' : ''; ?>" value="<?php echo date('M d,Y'); ?>">
														...
														<div class="input-right-box form-group">
															...
															<?php
																$currency=$controller->transaction_model->getAll('tbl_currency');
																if(!empty($currency)){
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>
																			...
																			<select required="" name="payment[0][ledgerId]" class="form-control accountLedgerNo  select2">
																		...
																		<td>
																			...
																			<div class="input-group calendar">
																					...
																					<input required="" readonly="" type="text" name="payment[0][chequeDate]" class="form-control datecheckno   <?php echo ($controller->has_access_of('edit_date_receipt_voucher')) ? 'datepicker' : ''; ?>" value="<?php echo date('M d,Y'); ?>">
												...
												<div class="input-right-box form-group">
													...
													<div class="col-sm-3 pull-right">
															...
															<a href="<?php echo base_url('accounting/Transactions/receiptVocher') ?>" class="btn btn-primary" style="width: 100%;"><?php lang('btn_close'); ?></a>
