                        ...
                        <div class="col-sm-12 reports">
                            <table class="table-box" >
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($products) && !empty($products)) {
                                            foreach ($products as $key=>$value) {
                                                echo '<tr>';
                                                    ...
                                                    echo '<td>';
                                                    // if(isset($value->tax->ledgerName)) {
                                                    //     echo $value->tax->ledgerName.' ('.$value->tax->tax_value.' '.$value->tax->tax_symbal.')';
                                                    // }
                                        ...
                                        ?>
                                        <tr><th colspan="6" style="text-align: center;"><?php lang('lab_no_found'); ?></th></tr>
                                        <?php } ?>
                                    </tbody>
                                    <?php
                                            ...
                                            if(isset($model->payment_return)) {
                                                echo '<tr>';
                                                    ...
                                                    echo '<th>';
                                                        lang('lab_payment');
                                                    echo '</th>';
                                                    echo '<th>'.number_format($model->payment_return, 2).'</th>';
                                                echo '</tr>';
                                                $balance = (float)$model->total - (float)$model->payment_return;
                                                echo '<tr>';
                                                    echo '<th colspan="4"></th>';
                                                    echo '<th>';
                                                            lang('lab_balance');
