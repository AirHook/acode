		            ...
		            <div class="scroll-element full-height-scroll">
					    <div class="row">
					       <div class="col-sm-12">
							...
							<div class="panel-heading"><?php lang('heading_sales_orders'); ?>
							<a href="<?php echo base_url('accounting/sales/saleOrder') ?>" class="btn btn-back pull-right"><i class="fa fa-reply"></i>&nbsp;&nbsp;<?php lang('btn_go_back'); ?></a>
							</div>
							  <div class="panel panel-body">
					          	 <span>
					                ...
					                <?php if(isset($model['id'])) { ?>
					               	<form action="<?php echo base_url('accounting/sales/editSaleOrder') ."/". $model['id']?>" method="POST" role="form">
					               <?php } else{ ?>
					               	<form action="<?php echo base_url('accounting/sales/addSaleOrder') ?>" method="POST" role="form">
					               <?php } ?>
					               <input type="hidden" name="saleorderNo" value="<?php echo isset($model['saleorderNo']) ? $model['saleorderNo'] :''; ?>">
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<div class="input-right form-group">
												<select required="" class="form-control customername select2" name="supplierId">
													<option></option>
													<?php
											...
											<div class="input-right form-group">
												<select required="" class="form-control select2" name="currencyId">
													<?php
														$result=$controller->sale_model->getAll('tbl_currency');
														if(!empty($result)){
															foreach($result as $value){?>
													 	 	<option <?php echo (isset($currency->currency->id) &&$currency->currency->id ==  $value->id) ? 'selected' :''; ?> value="<?php echo isset($value->id) ? $value->id :''; ?>">
										...
										<div class="col-sm-4">
											<div class="input-left-box form-group">
												<label><?php lang('lab_sales_order'); ?>:</label>
											</div>
											<div class="input-right-box form-group">
												<?php if(!empty($totalOrder)) { ?>
												<input required="" type="text" name="saleorderNo" value="<?php echo isset($totalOrder) ? sprintf("%0".$this->voucher_number_length."d",$totalOrder+1) :''; ?>" class="form-control" readonly="">
												<?php } else { ?>
												<input required="" type="text" name="saleorderNo" value="<?php echo isset($model['saleorderNo']) ? $model['saleorderNo'] :'0001'; ?>" class="form-control" readonly="">
											<?php } ?>
											</div>
											<div class="input-left-box form-group">
											...
											<div class="input-right-box form-group">
											<?php if(isset($model['sale_quotation_no'])) { ?>
												<select name="sale_quotation_no" class="form-control search-by-saleqoutation-no select2" >
													<option></option>
													<?php  
														$status=array('company_id'=>$this->session->userdata('company_id'));
														$saleQuotation=$controller->sale_model->getAll('tbl_saleqoutationmaster',$status, array('created_on', 'DESC'));
														if(!empty($saleQuotation)){
															foreach($saleQuotation as $saleQuotations){?>
													<option <?php echo (isset($model['sale_quotation_no']) && $model['sale_quotation_no'] == $saleQuotations->qoutationNo) ? 'selected' :''; ?> value="<?php echo isset($saleQuotations->qoutationNo) ? $saleQuotations->qoutationNo :''; ?>">
														<?php echo isset($saleQuotations->qoutationNo) ? $saleQuotations->qoutationNo :''; ?>
													</option>
													<?php } } ?>
												</select>
											<?php } else { ?>
												<select name="sale_quotation_no" class="form-control search-by-saleqoutation-no select2" >
													...
													<?php  
														...
														if(!empty($saleQuotation)){
															foreach($saleQuotation as $saleQuotations){?>
													<option value="<?php echo isset($saleQuotations->qoutationNo) ? $saleQuotations->qoutationNo :''; ?>">
														<?php echo isset($saleQuotations->qoutationNo) ? $saleQuotations->qoutationNo :''; ?>
													</option>
													<?php } } ?>
												</select>
											...
											<div class="input-right-box form-group">
												<div class="form-group ">
													...
													<?php if(isset($model['deliveryDate'])) { ?>
														<input required="" readonly="" type="text" name="deliveryDate" class="form-control deliveryDate <?php echo ($controller->has_access_of('edit_date_sale_orders')) ? 'datepicker' : ''; ?>" value="<?php echo isset($model['deliveryDate']) ? date("M d,Y",strtotime($model['deliveryDate'])) :''; ?>">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
													<?php }else { ?>
														<input required="" readonly="" type="text" name="deliveryDate" class="form-control deliveryDate <?php echo ($controller->has_access_of('edit_date_sale_orders')) ? 'datepicker' : ''; ?>" value="<?php echo date('M d,Y'); ?>">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
														<?php } ?>
													</div>
												</div>
									...
									<div class="well well-padding">
												...
												<table class="table products_list product_details">
													...
													<?php $serial_no=1;
														...
														<tr>
															...
															<!-- <span class="productNamehtml"><?php echo isset($abidzari->productName) ? $abidzari->productName :''; ?></span> -->
															...
															<td>
																<input  type="MyNumber" name="product[<?php echo $key ?>][discount_amount]" class=" form-control discount_amount" value="<?php echo isset($abidzari->discount_amount) ? $abidzari->discount_amount :''; ?>">
															</td>
															<td style="padding-top: 8px;">
															 ...
															 ?>
															 	<select name="product[<?php echo $key ?>][tax_id]" class="form-control appliedTaxesForSale">
																	<option value=""><?php lang(''); ?>--select--</option>
													...
													<?php }else { ?>
														<tr>
															...
															<td>
																<div class="form-group">
																	<input required="" type="text" name="product[0][barcode]" class="form-control barcodevalueForSale" value="">
																</div>
															</td>
															<td>
																<div class="form-group">
															...
															<td>
																<div class="form-group">
																	<select required="" class="form-control UOMId getSalePriceByUnit select2" name="product[0][UOMId]">
																		<option></option>
																		<?php 
																			$result=$controller->sale_model->getAll('tbl_uom');
																			if(!empty($result)){
															...
															<td>
																<input required="" type="MyNumber" name="product[0][rate]" class="purchaseRate form-control saleunitprice" value="00.00">
															</td>
															<td>
																<input  type="MyNumber" name="product[0][discount_amount]" class=" form-control discount_amount" value="">
															</td>
															<td style="padding-top: 8px;">
																<select name="product[0][tax_id]" class="form-control appliedTaxesForSale">
																	<option><?php lang(''); ?>--select--</option>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												...
												<div class="input-right-box form-group">
													<input required="" type="MyNumber" value="<?php echo isset($model['percentDiscount']) ? $model['percentDiscount'] :'0'; ?>" class="form-control discount discountForSale" name="percentDiscount">
										...
										<div class="row">
											...
											<div class="col-sm-8">
												...
												<div class="col-sm-4">
													<a href="<?php echo base_url('accounting/sales/saleOrder') ?>" class="btn btn-primary" style="width: 100%;"><?php lang('btn_close'); ?></a>
												</div>
											</div>
											</div>
										</div>
