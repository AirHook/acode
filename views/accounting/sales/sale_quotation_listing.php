        ...
        <div class="col-sm-12 overflow-hide">
            ...
            <div class="ibox overflow-hide">
                ...
                <div class="ibox-content">
                    ...
                    <h2> <?php lang('heading_sale_quotations'); ?> 

						<span class="pull-right">
						<?php if ($controller->has_access_of('add_sale_quotation')) { ?>

							<a  href="<?php echo base_url('accounting/sales/AddSaleQuotation') ?>" class="btn  btn-primary "> <i class="fa fa-plus"></i> <?php lang('btn_add_new'); ?> </a>&nbsp;
						<?php } ?>
						</span>
                               ...
                               <table class="table table-striped table-hover table-hover dataTables1 data-table">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                        	...
                                        	<th><?php lang('lab_sale_quotation_number'); ?></th>
                                    ...
                                    <?php if(!empty($allData)){
										...
										<tr>
											...
											<td>
												...
												<?php if(isset($value->discount) && $value->discount != '') {
											...
											<td>
											<?php if ($controller->has_access_of('delete_sale_quotation')) { ?>
												<a href="<?php echo base_url('accounting/sales/deleteQuotation') ."/". $value->qoutationNo ?>" class="btn delete-confirm "><i class="fa fa-trash-o"></i></a>
											<?php } ?>
											<?php if ($controller->has_access_of('view_sale_quotation')) { ?>
												<a href="<?php echo base_url('accounting/sales/AddSaleQuotation') ."/".encode_url($value->qoutationNo) ?>" class="btn btn-xs btn-primary"><i class="fa fa-detail"></i><?php lang('btn_view_detail'); ?></a>
											<?php } ?>
											</td>
