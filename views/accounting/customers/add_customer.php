						        ...
						        <div class="row">
						        	<div class="col-sm-12">
							        	...
							        	<div class="panel panel-heading">
											...
											<?php lang('heading_customer_detail'); ?>
								        	<?php } else { ?>
											<?php lang('heading_customer_detail'); ?>
											<?php } ?>
									<a href="<?php echo base_url('accounting/customers/index') ?>" class="btn btn-back pull-right"><i class="fa fa-reply"></i>&nbsp;&nbsp;<?php lang('btn_go_back'); ?></a>
							        	</div>
							        	<?php if(isset($model['id'])) { ?>
						               	<form action="<?php echo base_url('accounting/customers/addCustomer') ."/". $this->uri->segment(4) ?>" method="POST" role="form">
						                     <input type="hidden" name="id" value="<?php echo isset($model['id']) ?  $model['id'] :''; ?>">
						               <?php } else { ?>
						               	<form action="<?php echo base_url('accounting/customers/addCustomer') ?>" method="POST" role="form">
						               <?php } ?>
							        	...
							        	<div class="">
							        		<div class="row ">
									        			...
									        			<div class="row">
										               		<div class="col-sm-6">
										               			<div class="form-group">
										               				<label class="panelheadingfont"><?php lang('lab_customer_name'); ?></label>
										               		 		<input required="" type="text" name="customerName" value="<?php echo isset($model['customerName']) ? $model['customerName'] :''; ?>" class="form-control">
										               			</div>
										               		</div>
										               		<div class="col-sm-6">
										               			<div class="form-group">
										               				<label class="panelheadingfont"><?php lang('lab_customer_code'); ?></label>
										               		 		<input type="text" value="<?php echo isset($model['customerCode']) ? $model['customerCode'] : $customer_code; ?>" readonly="true" class="form-control">
										               		 		<input type="hidden" name="customerCode" value="<?php echo isset($model['customerCode']) ? $model['customerCode'] : $customer_code; ?>" >
										               			</div>
										               		</div>
										               	</div>
										               	<div class="row">
										               	...
										               	<div class="row">
										               		<div class="col-sm-6">
										               			<div class="form-group">
										               				...
										               				<input type="MyNumber" <?php echo isset($model['opening_balance']) ? 'readonly' :''; ?> name="opening_balance" value="<?php echo isset($model['opening_balance']) ? $model['opening_balance'] :''; ?>" class="form-control">
										               			</div>
										               		</div>
										               		<div class="col-sm-6">
									        					<div class="form-group">
									        						<label><?php lang('lab_debit_credit'); ?></label>
									        						<select  <?php echo (isset($model['crOrDr']) && $model['crOrDr']!='') ? 'disabled' :''; ?> class="form-control" name="crOrDr">
									        							<option  value=""><?php lang('lab_select_option'); ?></option>
							        		    ...
							        		    <div class="col-sm-6">
									        		<div class="">
										               	<div class="row">
										               		...
										               		<div class="col-sm-6">
										               			<div class="form-group">
										               				<label class="panelheadingfont"><?php lang('lab_credit_limit'); ?></label>
										               	...
										               	<div class="row">
										               		<div class="col-sm-12">
										               			<div class="form-group">
										               				...
										               				<textarea class="form-control" name="address"><?php echo isset($model['address']) ? trim($model['address']) :''; ?></textarea>
										               			</div>
										               		</div>
										               	</div>
									        		</div>
							        		    ...
							        		    <div class="row">
								                	...
								                	&nbsp;&nbsp;
								                	<a href="<?php echo base_url('accounting/customers/index') ?>" class="form-btn btn  btn-primary btn-default1 ">
								                		<?php lang('btn_cancel'); ?>
								                	</a>
								                	</div>
								                </div>
