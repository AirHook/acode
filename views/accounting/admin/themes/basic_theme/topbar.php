<!-- <div class="skin-option animated fadeInRight">
    <a href="light-shadow/index.html" target="_blank">
        ...
        <img class="img-responsive m-t-xs" src="<?php echo $this->theme_css_path ?>images/light-skin.png"/>
    </a>
</div> -->
<style>
    .skin-option {
    ...
    <nav role="navigation">
        ...
        <form role="search" class="navbar-form-custom" method="post" action="#">
            <div class="form-group">
                <h5><?php echo date('Y-m-d H:i:s e'); ?></h5>
        ...
        <div class="mobile-menu">
            ...
            <div class="collapse mobile-navbar" id="mobile-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a class="" href="<?php echo base_url('auth/logout') ?>">Login</a>
                    </li>
                    <li>
