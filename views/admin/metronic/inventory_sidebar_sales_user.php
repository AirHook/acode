											...
											$prefix_link =
												@$role == 'sales'
												? 'my_account/sales/inventory/'.$inv_prefix.'/index'
												: 'admin/inventory/'.$inv_prefix.'/index'
											;
											?>
											<style>
											...
											<div class="panel-group accordion" id="accordion3">
															...
															<div class="select-designer-categories">
																...
																<ul class="list-unstyled nested-nav">
																	...
																	<li class="designer_list <?php echo $designer->des_id; ?>" data-des_id="<?php echo $designer->des_id; ?>" data-designer_slug="<?php echo $designer->url_structure; ?>" data-designer_name="<?php echo $designer->designer; ?>">
																		<a href="<?php echo site_url($prefix_link.'/'.$designer->url_structure); ?>" style="<?php echo $this->uri->uri_string() == $prefix_link.'/'.$designer->url_structure ? 'color:#23527c;text-decoration:underline;' : ''; ?>">
																			...
																			<ul class="list-unstyled nested-nav" style="" data-row_count="<?php echo $number_of_categories; ?>">
																				...
																				foreach ($des_subcats as $subcat)
																				{
																					...
																					if ($ic == 1)
																					{
																						...
																						// set link
																						$this_link = $prefix_link.'/'.$designer->url_structure.'/'.implode('/', $li_a_link);
												...
												<div class="panel panel-default ">
													<div class="panel-heading">
														<h4 class="panel-title">
															<!-- DOC: Apply class "collapsed" to initially hide panel -->
															<a class="accordion-toggle accordion-toggle-styled " data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_2"> By <?php echo $this->webspace_details->options['site_type'] == 'hub_site' ? 'General' : ''; ?> Categories </a>
														</h4>
													</div>
													<!-- DOC: Apply class "collapse" to initially hide panel -->
																...
																<ul class="list-unstyled nested-nav" style="" data-row_count="<?php echo $number_of_categories; ?>">
																	...
																	foreach ($categories as $category)
																	{
																		...
																		if ($ic == 1)
																		{
																			...
																			// set link
																			$this_link = $prefix_link.'/'.implode('/', $li_a_link);
