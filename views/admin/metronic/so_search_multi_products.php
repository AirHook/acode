...
<div class="margin-top-20">
	...
	<?php } ?>
	<?php if ($this->session->flashdata('error') == 'empty_style_ary') { ?>
	<div class="alert alert-danger">
		<button class="close" data-close="alert"></button> Please enter any Style No at least once.
	</div>
	<?php } ?>
</div>

<div style="position:relative;">
	Please enter one STYLE NUMBER per box for as many as 40 items only. <span style="color:red;font-style:italic;">(Style Numbers only please.)</span>
	<br /><br />

	<!--bof form==========================================================================-->
	<?php echo form_open(
		'sales/sales_orders/search_multiple',
		array(
		...
		<br />
		<button type="submit" class="btn dark "> SEARCH ITEMS </button>
