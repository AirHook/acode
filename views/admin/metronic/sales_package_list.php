                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX " onmouseover="$(this).find('.hidden_first_edit_link').show();" onmouseout="$(this).find('.hidden_first_edit_link').hide();">
                                ...
                                <td>
									...
									&nbsp;
									<a class="text-danger" href="<?php echo site_url($this->config->slash_item('admin_folder').'campaigns/sales_package/edit/step1/'.$package->sales_package_id); ?>"><small><cite>Select items first for this package</cite></small></a>
									<?php } ?>
									<!-- -->
									&nbsp;
									<?php if ($package->sales_package_id == '2') { ?>
									...
									<?php } else { ?>
									<a class="hidden_first_edit_link" style="display:none;" href="<?php echo site_url($this->config->slash_item('admin_folder').'campaigns/sales_package/edit/step1/'.$package->sales_package_id); ?>">
									<?php } ?>
										<small><cite>view/edit</cite></small></a>
                                        <br /><br />
