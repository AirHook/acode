											...
											<div class="panel-group accordion" id="accordion3">
												...
												/**********
												 * By Vendor
												 * Only when by_vendor tab/menu item is selected
												 */
												?>
												<?php
												if (@$vendors)
													...
													<div class="panel panel-default ">
														<div class="panel-heading">
															<h4 class="panel-title">
																...
																<a class="accordion-toggle accordion-toggle-styled " data-toggle="collapse" data-parent="#accordion3" href="#collapse_3_1"> By Vendor </a>
															</h4>
														</div>
															...
															<div class="panel-body">
																...
																<div class="select-designer-categories">
																	...
																	<ul class="list-unstyled nested-nav">
																		...
																		{
																			$vendor_active = in_array(strtolower($vendor->vendor_code), $url_segs) ? 'active': '';
																			?>

																		<li class="designer_list <?php echo $vendor->vendor_id; ?>" data-des_id="<?php echo $vendor->vendor_id; ?>" data-vendor_code="<?php echo $vendor->vendor_code; ?>" data-vendor_name="<?php echo $vendor->vendor_name; ?>">
																			<a href="<?php echo site_url($pre_link.'/'.strtolower($vendor->vendor_code)); ?>" style="<?php echo $this->uri->uri_string() == $pre_link.'/'.strtolower($vendor->vendor_code) ? 'color:#23527c;text-decoration:underline;' : ''; ?>">
																				<?php echo ($vendor_active ? '<strong>' : '').$vendor->vendor_name.($vendor_active ? '</strong>' : ''); ?>
																			</a>
																		</li>
