						...
						<div class="form-body">
							<ul class="nav nav-pills nav-justified steps">
								...
								<li class="<?php echo @$steps == 1 ? 'active' : ''; ?><?php echo @$steps > 1 ? 'done' : ''; ?>">
									<a href="javascript:;" data-toggle="tab" class="step" onclick="location.href='<?php echo site_url('admin/purchase_orders/create/step1'); ?>'">
								...
								<li class="<?php echo @$steps == 2 ? 'active' : ''; ?><?php echo @$steps > 2 ? 'done' : ''; ?>">
									<a href="javascript:;" data-toggle="tab" class="step" onclick="location.href='<?php echo site_url('admin/purchase_orders/create/step2/womens_apparel'); ?>'">
								...
								<li class="<?php echo @$steps == 3 ? 'active' : ''; ?><?php echo @$steps > 3 ? 'done' : ''; ?>">
									<?php
									$step3_link = $steps >= 3 ? site_url('admin/purchase_orders/create/step3') : '';
									?>
									<a href="javascript:;" data-toggle="tab" class="step" data-step="3" data-link="<?php echo site_url('admin/purchase_orders/create/step3'); ?>">
								...
								<li class="<?php echo @$steps == 4 ? 'active' : ''; ?><?php echo @$steps > 4 ? 'done' : ''; ?>">
									<a href="javascript:;" data-toggle="tab" class="step step4 <?php echo (@$steps == 3 && $po_items_count > 0) ? 'mt-bootbox-new submit-po_summary_review' : ''; ?> " data-step="4" data-link="<?php echo site_url('admin/purchase_orders/create/step4'); ?>">
