                    ...
                    <div class="row body-content" data-object_data='{"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"}'>
                        ...
                        <div class="col col-md-6" style="border:1px solid #ccc;min-height:500px;">
                            <div class="row">
                                ...
                                <div class="col-sm-12 sa-info">
                                    ...
                                    <div class="form-body sa_info">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="email_subject" class="form-control input-sa_info clear-readonly" value="<?php echo $sa_email_subject; ?>" readonly />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea name="email_message" class="form-control summernote input-sa_info" id="summernote_1" data-error-container="email_message_error" readonly><?php echo $sa_email_message; ?></textarea>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <h4 style="margin:5px 0;">Photo Package Items</h4>
                                	...
                                	?>
                                	<!--<table cellspacing="0" cellpadding="0" border="0" style="<?php echo @$file == 'sa_pp_send_package' ? '' : 'width:758px;'; ?>">-->
                                    <table cellspacing="0" cellpadding="0" border="0" style="<?php echo @$file == 'sa_pp_send_package' ? '' : 'width:610px;'; ?>">
                                		<tbody>
                                			<tr>
                                				<td>
                                					 ...
                                					 */
                                					?>
                                					<table cellspacing="0" cellpadding="0" border="0" style="margin-top:10px;<?php echo @$file == 'sa_pp_send_package' ? '' : 'width:610px;'; ?>">
                                						<tbody>
                                								<?php
                                								// load library
                                								...
                                								foreach($sa_items as $item)
                                								{
                                									...
                                									else
                                									{
                                                                        ...
                                                                        $img_side_new = $this->config->item('PROD_IMG_URL').'images/instylelnylogo_3.jpg';
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <h3> <?php echo $prod_no.' ('.$color_name.')'; ?> </h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="center" style="vertical-align:top;width:33%;padding-right:5px;padding-left:5px;">
                                									<a href="<?php echo @$access_link; ?>" style="text-decoration:none;margin:0;padding:0;color:inherit;display:inline-block;">
                                										<div id="spthumbdiv_<?php echo $item; ?>" class="fadehover" style="<?php echo @$file == 'sa_send' ? '' : 'width:100%;'; ?>">
                                											<img src="<?php echo $img_side_new; ?>" alt="<?php echo $prod_no; ?>" title="<?php echo $prod_no; ?>" border="0" style="width:100%;">
                                										</div>
                                									</a>
                                								</td>
                                                                <td align="right" style="vertical-align:top;width:33%;padding-left:10px;">
                                									<a href="<?php echo @$access_link; ?>" style="text-decoration:none;margin:0;padding:0;color:inherit;display:inline-block;">
                                										<div id="spthumbdiv_<?php echo $item; ?>" class="fadehover" style="<?php echo @$file == 'sa_send' ? '' : 'width:100%;'; ?>">
                                											<img src="<?php echo $img_back_new; ?>" alt="<?php echo $prod_no; ?>" title="<?php echo $prod_no; ?>" border="0" style="width:100%;">
                                										</div>
                                									</a>
                                								</td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3" style="padding-top:10px;">
                                                                    <a href="<?php echo @$access_link; ?>" style="text-decoration:none;margin:0;padding:0;color:inherit;display:inline-block;">
                                										<div id="spthumbdiv_<?php echo $item; ?>" class="fadehover" style="<?php echo @$file == 'sa_send' ? '' : 'width:100%;'; ?>">
                                											<img src="<?php echo $img_linesheet; ?>" alt="<?php echo $prod_no; ?>" title="<?php echo $prod_no; ?>" border="0" style="width:100%;">
                                										</div>
                                									</a>
                                                                </td>
                                                            </tr>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-select-users-wrapper">
                                ...
                                <!-- FORM =======================================================================-->
                                <?php echo form_open(
                                    (@$role == 'sales' ? 'my_account/sales' : 'admin/campaigns').'/photo_package/send_package/send',
                                    array(
                                        'class' => 'form-horizontal',
