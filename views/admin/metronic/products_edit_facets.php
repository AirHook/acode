												...
												<div class="form-body" data-base_url="<?php echo base_url(); ?>" data-object_data='{"prod_id":"<?php echo $this->product_details->prod_id; ?>","<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>","prod_no":"<?php echo $this->product_details->prod_no; ?>"}'>
													...
													<div class="form-group" >
														...
														<div class="mt-checkbox-inline" data-facet_type="seasons">

															<?php
															foreach ($seasons as $season) {
															$seasons_check = in_array(strtoupper($season->season_name), $this->product_details->season_facets) ? 'checked="checked"' : '';
															?>

															<label class="mt-checkbox mt-checkbox-outline col-md-3 col-sm-5">
																<input type="checkbox" class="facets" name="seasons[]" value="<?php echo $season->season_name; ?>" <?php echo $seasons_check; ?> /> <?php echo $season->season_name; ?>
																<span></span>
															</label>
