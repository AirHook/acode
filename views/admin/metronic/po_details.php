                                            ...
                                            <tr class="summary-item-container">
                                                ...
                                                <td class="size-and-qty-wrapper" style="vertical-align:top;">
                                                    ...
                                                    <div style="display:inline-block;">
                                                        ...
                                                        <br />
                                                        <a class="small text-default tooltips print-upc-size <?php echo $s_qty > 0 ? '' : 'invisible'; ?>" data-original-title="Print Barcodes of this size" data-placement="bottom" data-url="<?php echo $url_pre.'/barcodes/print/po_item/index/'.$po_details->po_id.'/'.$item.'/'.$size_label; ?>" target="_blank" data-item="<?php echo $item; ?>" data-size="<?php echo $s; ?>">
