                            ...
                            <div class="form-horizontal" role="form">
    							...
    							<div class="form-body" data-object_data='{"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"}'>
                                    ...
                                    <div class="form-group">
        								...
        								?>
                                        <div class="col-md-12">
                                            <a href="javascript:;" class="btn dark btn-md btn-active select-send-options send-to-current-user col-md-3 <?php echo @$ws_user_details ? 'hide' : ''; ?>" style="font-size:0.9em;background-color:#E5E5E5;color: black;">
                                                Existing User(s)
                                            </a>
                                            <a href="javascript:;" class="btn dark btn-md select-send-options send-to-new-user col-md-3 <?php echo @$ws_user_details ? 'hide' : ''; ?>" style="font-size:0.9em;">
                                                New Wholesale User
                                            </a>
