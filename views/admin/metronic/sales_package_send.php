							...
							<div class="portlet ">
								<div class="portlet-title">
									...
									<div class="alert alert-success auto-remove">
										<button class="close" data-close="alert"></button> Sales Package sending to multiple email in progress...
									</div>
									<?php } ?>
						...
						<!-- BEGIN FORM-->
						<!-- FORM =======================================================================-->
						<?php echo form_open($this->config->slash_item('admin_folder').'campaigns/sales_package/send/index/'.$this->sales_package_details->sales_package_id, array('class'=>'form-horizontal')); ?>
							...
							<div class="portlet box blue-hoki form">
								...
								<div class="portlet-body">
									<div class="form-body">
										<div class="row">
											<div class="actions btn-set">
												<button type="submit" class="btn blue btn-lg btn-block mt-ladda-btn ladda-button mt-progress-demo" data-style="slide-left">
						...
						<div class="col-lg-9 col-md-8 col-xs-12 pull-left">
                            ...
                            <div class="portlet box blue-hoki">
								...
								<div class="portlet-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <select multiple="multiple" class="multi-select" id="my_multi_select1" name="users[]" style="width:200px;">
                                                        ...
                                                        <option value="<?php echo $user->email; ?>"><?php echo $user->firstname.' '.$user->lastname?> <small>&lt;<?php echo $user->email; ?>&gt;</small></option>
									...
									<h2> <?php echo $this->sales_package_details->name; ?> 
									<span class="actions btn-set text-right">
										<a class="btn btn-secondary-outline" href="<?php echo site_url($this->config->slash_item('admin_folder').'campaigns/sales_package/edit/index/'.$this->sales_package_details->sales_package_id); ?>">
