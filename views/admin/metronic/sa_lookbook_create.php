                        ...
                        <div class="col col-md-6 form-horizontal" role="form">
							...
							<div class="form-body" data-object_data='{"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"}'>
								...
								<div class="notifications">
            						...
            						<div class="alert alert-danger auto-remove">
            							<button class="close" data-close="alert"></button> Lookbook not sent. Please try again.
            						</div>
            						<?php } ?>
                                ...
                                <div class="form-group form-group-badge select-designer-dropdown">
                                    ...
                                    <div class="col-md-7">
                                        <select class="bs-select form-control" name="des_slug" data-live-search="true" data-size="5" data-show-subtext="true" data-access_level="<?php echo $this->sales_user_details->access_level; ?>" data-page="create">
                                            ...
                                            <option value="<?php echo $designer->url_structure; ?>" data-subtext="<em><?php echo $designer->domain_name; ?></em>" data-des_slug="<?php echo $designer->url_structure; ?>" data-des_id="<?php echo $designer->des_id; ?>" <?php echo $designer->url_structure === $this->session->lb_des_slug ? 'selected="selected"' : ''; ?>>
                                            ...
                                            <option value="<?php echo $designer->url_structure; ?>" data-subtext="<em><?php echo $designer->domain_name; ?></em>" data-des_slug="<?php echo $designer->url_structure; ?>" data-des_id="<?php echo $designer->des_id; ?>" <?php echo $designer->url_structure === $this->session->admin_lb_des_slug ? 'selected="selected"' : ''; ?>>
                                                <?php echo ucwords(strtolower($designer->designer)); ?>
                                            </option>
                                        ...
                                        <input type="hidden" name="des_slug" value="<?php echo @$role == 'sales' ? $this->session->lb_des_slug : $this->session->admin_lb_des_slug; ?>" />
                                    </div>
                                </div>
								<div class="form-group form-group-badge">
                                    <label class="control-label col-md-5">
                                        <span class="badge custom-badge pull-left step-select_items step2 <?php echo ($this->session->admin_lb_des_slug OR $this->session->lb_des_slug) ? 'active' : ''; ?>"> 2 </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <a href="javascript:;" class="btn dark btn-md select-product-options thumbs-grid-view col-md-4" style="<?php echo ($this->session->admin_lb_des_slug OR $this->session->lb_des_slug) ? 'background-color:#696969;' : ''; ?>">
                                ...
                                <div class="thumbs-grid">
                                    ...
                                    <div class="input-group categories-tree-wrapper">
                                        ...
                                        <div class="form-control cat_crumbs" style="font-style:italic;font-size:0.8em;">
                                            <?php
                                            echo @$slug_segs ? implode(' &nbsp;&raquo;&nbsp; ', @$slug_segs_name) : '';
                                            ?>
                                        </div>
                                    </div>
                                    <!-- /input-group -->
                                    ...
                                    <div class="thumb-tiles-wrapper margin-top-20 <?php echo @$des_subcats ? '' : 'display-none'; ?>" data-row-count="<?php echo @$products_count; ?>" data-object_data='{"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"}'>
        								...
        								<div class="thumb-tiles">
        									...
        									<div class="thumb-tile image bg-blue-hoki <?php echo $classes.' '.$product->new_color_publish; ?> " style="<?php echo $styles; ?>">
                                                ...
                                                <a href="javascript:;" class="package_items" data-prod_no="<?php echo $product->prod_no; ?>" data-item="<?php echo $product->prod_no.'_'.$product->color_code; ?>" data-page="create" data-category_slug="<?php echo $category_slug; ?>" data-access_level="<?php echo @$this->sales_user_details->access_level ?: '0'; ?>">
                        ...
                        <div class="col col-md-6" style="border:1px solid #ccc;min-height:500px;">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group form-group-badge">
                                        <label class="control-label col-md-5">
                                            <span class="badge custom-badge pull-left step-refine_sales_package step3 <?php echo @$lb_items ? 'active' : ''; ?>"> 3 </span>
                                            <span class="badge-label"> Refine Sales Package </span>
                                        </label>
                                        <div class="col-md-7">
                                            <cite class="help-block font-red" style="position:relative;top:-4px;">
                                                Selected items will show in this Sales Package.
                                            </cite>
                                        </div>
                                    </div>
                                ...
                                <!-- BEGIN FORM =======================================================-->
                                <?php echo form_open(
                                    (@$role == 'sales' ? 'my_account/sales' : 'admin/campaigns').'/lookbook/create',
                                    array(
                                        'class' => 'form-horizontal',
                                        'id' => 'form-lb_create_summary_review'
                                    )
                                ); ?>
                                ...
                                <div class="col-sm-12 sa-info">
                                    ...
                                    <div class="form-body sa_info">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="lookbook_name" data-required="1" class="form-control input-sa_info" value="<?php echo @$role == 'sales' ? $this->session->lb_name : $this->session->admin_lb_name; ?>" placeholder="Lookbook Name" data-page="create" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="email_subject" data-required="1" class="form-control input-sa_info" value="<?php echo @$role == 'sales' ? @$this->session->lb_email_subject : @$this->session->admin_lb_email_subject; ?>" placeholder="Email Subject" data-page="create" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="email_message" class="form-control summernote input-sa_info" id="summernote_1" data-error-container="email_message_error" data-page="create"><?php echo @$role == 'sales' ? $this->session->lb_email_message : $this->session->admin_lb_email_message ?: 'Please review the attached look book for your stores.'; ?></textarea>
                                ...
                                <div class="col-sm-12 cart_basket_wrapper" style="margin-bottom:70px;">
                                    <div class="cart_basket">
                                        ...
                                        <?php $this->load->view('admin/metronic/sa_lookbook_create_items'); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="mt-checkbox-list ">
                                        <label class="mt-checkbox mt-checkbox-outline" style="font-size:12px;">
                                            Do you want to save Lookbook to your list?
                                            <input type="checkbox" class="" name="save_lookbook" value="1" />
                                            <span></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="alert alert-danger alert-no-items display-hide margin-top-20" data-test="test">
                                        <button class="close" data-close="alert"></button> You have NOT selected any items for the Lookbook. Please select now. </div>
                                </div>
                                ...
                                <div class="col-sm-12 steps">
                                    ...
                                    <div class="form-group form-group-badge clearfix" style="margin-bottom:0px;">
                                        <label class="control-label col-md-5">
                                            ...
                                            <span class="badge-label"> Save and Send Lookbook </span>
                                        </label>
                                        <div class="col-md-7">
                                            <cite class="help-block font-red" style="position:relative;top:-4px;">
                                                Lookbook will be saved and can be sent to users.
                                            </cite>
                                        </div>
                                    </div>

                                    <hr style="margin-top:0px;" />
                                    <a href="<?php echo site_url((@$role == 'sales' ? 'my_account/sales' : 'admin/campaigns').'/lookbook/reset'); ?>" style="color:#333;">
                                        <div class="form-group form-group-badge form-group-badge-step6 clearfix">
                                            <label class="control-label col-md-5" style="cursor:pointer;">
                                                ...
                                                <span class="badge-label"> Clear Lookbook </span>
                                            </label>
                                            <div class="col-md-7">
                                                <cite class="help-block font-red" style="position:relative;top:-4px;">
                                                    Lookbook will be cleared of items.
                                                </cite>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn dark modal-size_qty_submit"> Add To Lookbook </button>
                                    </div>
