...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
			...
			<!-- FORM =======================================================================-->
			<?php echo form_open(
                $this->config->slash_item('admin_folder').'login/validate',
                array(
                    'class'=>'login-form',
                    'data-webspace_id'=>$this->webspace_details->id
                )
            ); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" value="<?php echo $this->session->userdata('remember-at-admin') ? $this->session->userdata('remember-at-admin-username') : ''; ?>" <?php echo $this->session->userdata('remember-at-admin') ? '' : 'autofocus'; ?> /> </div>
                <div class="form-group">
			...
			<?php echo form_open($this->config->slash_item('admin_folder').'login/forget_password', array('class'=>'forget-form')); ?>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-success uppercase pull-right hide">Submit</button>
                </div>
            </form>
			<!-- End FORM ===================================================================-->
			<!-- END FORM-->
			...
			<?php echo form_open($this->config->slash_item('admin_folder').'login/register', array('class'=>'register-form')); ?>
                ...
                <p class="hint hide"> Enter your personal details below: </p>
			<div class="hide">
                <div class="form-group">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" id="register-submit-btn" class="btn btn-success uppercase pull-right hide">Submit</button>
                </div>
            </form>
			<!-- End FORM ===================================================================-->
			<!-- END FORM-->
...
<![endif]-->
        ...
        <script src="<?php echo base_url('assets/custom'); ?>/js/metronic/login.js" type="text/javascript"></script>
