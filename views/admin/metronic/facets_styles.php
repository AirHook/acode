												<div class="col-md-4 margin-bottom-20">
													...
													<div class="row">
														<div class="col-md-12">
															<h1>Styles Facets</h1>
															<hr />
															<p>Simlpy type in a new Style facet name and click on the button to Add New Facet. The new facet should appear in the list afterwards.</p>
														</div>
													</div>

													<!-- BEGIN FORM-->
													<!-- FORM =======================================================================-->
													<?php echo form_open($this->config->slash_item('admin_folder').'facets/add', array('class'=>'form-horizontal', 'id'=>'form-styles_facets_add')); ?>
													...
													<div class="form-body">
														<div class="form-group">
															<label class="col-lg-4 control-label">Style Name:
																<span class="required"> * </span>
															</label>
															<div class="col-lg-8">
																<input type="text" class="form-control facet_name" data-facet="styles" name="style_name" value="">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control facet_slug" data-facet="styles" name="url_structure" value="" tabindex="-1">
															</div>
														</div>
													</div>
												...
												<div class="col-md-8">
													...
													<table class="table table-striped table-hover table-checkable order-column" id="tbl-facets_styles">
														<thead>
															<tr>
																<th class="hidden-xs hidden-sm"> <!-- counter --> </th>
																<th class="text-center">
																	<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
																		<input type="checkbox" id="heading_checkbox-styles" class="group-checkable" data-set="#tbl-facets_styles .checkboxes" />
																		<span></span>
																	</label>
																</th>
																<th> Style Facet Name </th>
																<th> Slug </th>
																<th> Actions </th>
															</tr>
														</thead>
														<tbody>
															...
															<tr class="odd gradeX " onmouseover="$(this).find('.hidden_first_edit_link').show();" onmouseout="$(this).find('.hidden_first_edit_link').hide();">
																...
																<td class="text-center">
																	<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
																		<input type="checkbox" class="checkboxes" name="checkbox[]" value="<?php echo $style->style_id; ?>" />
																		<span></span>
																	</label>
																</td>
																<td>
																	<a href="#edit-styles-facet-<?php echo $style->style_id; ?>" data-toggle="modal">
																	<?php echo $style->style_name; ?></a>
																	<!--
																	&nbsp; &nbsp;
																	<a class="hidden_first_edit_link" style="display:none;" href="#edit-styles-facet-<?php echo $style->style_id; ?>" data-toggle="modal"><small><cite>edit</cite></small></a>-->
																</td>
																<td>
																	<cite><?php echo $style->url_structure; ?></cite>
																</td>
																<td class="dropdown-wrap dropdown-fix">
																	<div class="btn-group" >
																		...
																		<ul class="dropdown-menu pull-right">
																			...
																			<li>
																				<a data-toggle="modal" href="#delete-styles-facet-<?php echo $style->style_id; ?>">
																					<i class="icon-trash"></i> Delete </a>
																			</li>
																		</ul>
																	</div>
																	<!-- ITEM EDIT -->
																	<div class="modal fade bs-modal-md" id="edit-styles-facet-<?php echo $style->style_id?>" tabindex="-1" role="dialog" aria-hidden="true">
																		<div class="modal-dialog modal-md">
																			<div class="modal-content">
																				...
																				<div class="modal-footer">
																					...
																					<a href="<?php echo site_url($this->config->slash_item('admin_folder').'facets/edit/index/'.$style->style_id); ?>" type="button" class="btn red-flamingo mt-ladda-btn ladda-button" data-style="expand-left">
																	...
																	<!-- /.modal -->
																	<!-- ITEM DELETE -->
																	<div class="modal fade bs-modal-sm" id="delete-styles-facet-<?php echo $style->style_id?>" tabindex="-1" role="dialog" aria-hidden="true">
																		<div class="modal-dialog modal-sm">
																			<div class="modal-content">
																				...
																				<div class="modal-footer">
																					<button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
																					<a href="<?php echo site_url($this->config->slash_item('admin_folder').'facets/delete/index/styles/'.$style->style_id); ?>" type="button" class="btn red-flamingo mt-ladda-btn ladda-button" data-style="expand-left">
																						<span class="ladda-label">Confirm?</span>
																						<span class="ladda-spinner"></span>
																					</a>
																				</div>
