												...
												<div class="col-sm-12 po-summary-addresses">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
															...
															<h5> SHIP TO
                                                                <a href="#modal-edit_ship_to" data-toggle="modal" class="small ship-to-popovers popovers" data-trigger="hover" data-placement="top" data-container="body" data-content="Click here to change 'Ship To' address. Reset to return to default." data-original-title="EDIT Shipt To" style="margin-left:10px;"> edit </a> <small>/</small> <a href="<?php echo site_url('admin/purchase_orders/create/reset_ship_to'); ?>" class="small"> reset </a>
                                                            </h5>
                                                ...
                                                <div class="col-sm-12 m-grid po-summary-dates">
                                                    <div class="m-grid-row">
                                                        ...
                                                        <div class="m-grid-col m-grid-col-sm-2">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12">
                                                                    <input class="form-control form-control-inline date-picker" size="16" type="text" value="" name="delivery_date" data-date-format="yyyy-mm-dd" data-date-start-date="+0d" />
                                                                    <span class="help-block"> Click to Select date </span>
                                                                </div>
                                                            </div>
																	...
																	<tr class="summary-item-container">
																		...
																		<td class="size-and-qty-wrapper">
                                                                            ...
                                                                            <div style="display:inline-block;">
                                                                                <?php echo $s; ?> <br />
                                                                                <select name="size_<?php echo $s; ?>" class="size-select" style="border:1px solid #<?php echo $size_qty > 0 ? '000' : 'ccc'; ?>;" data-page="create" data-prod_no="<?php echo $item; ?>" data-vendor_price="<?php echo @$product->vendor_price; ?>">
                                                                                    <?php
                                                                                    for ($i=0;$i<31;$i++)
                                                                                    {
        												...
        												<div class="col-sm-4">
        													...
        													<div class="row">
        														<div class="col-sm-8 pull-right">
        															...
        															<button class="btn dark btn-block mt-bootbox-new submit-po_summary_review"> Submit Purchase Order </button>
        														</div>
        													</div>
