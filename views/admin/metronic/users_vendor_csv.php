                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right tooltips" data-container="body" data-placement="left" data-original-title="Always update CSV file before downloading to ensure getting most recent information">
                                        <li>
                                            <a href="<?php echo site_url('admin/users/vendor/csv/update_csv_file'); ?>" onclick="$('#loading').modal('show');">
                                                <i class="fa fa-save"></i> Update CSV File </a>
                                        </li>
                                        <li class="divider"> </li>
                                        <li>
                                            <a href="<?php echo base_url(); ?>csv/users/users_vendor_shop7thavenue_hub_site.php">
                    ...
                    <table class="table table-striped table-condensed table-bordered table-hover dataTable" width="100%" id="tbl-users_vendor_csv">
                        <thead>
                            <tr>
                                <th> Edit </th>
                                <th> Vendor ID </th>
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX ">
                                ...
                                <td class="popovers" data-trigger="focus" data-placement="top" data-container="body" data-original-title="Reference Active Designer Options:" data-content="<?php foreach($vendor_types as $type){ echo $type->slug.', '; }?>"> <?php echo $user->slug; ?> </td>
					...
					<div class="modal fade bs-modal-lg" id="modal-csv_upload" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-lg" id="modal-csv_upload-modal-dialog">
							<div class="modal-content" id="modal-csv_upload-modal-content">
								...
								<!-- FORM =======================================================================-->
								<?php echo form_open(
									$this->config->slash_item('admin_folder').'users/vendor/csv/upload_csv_file',
									array(
										'method'=>'POST',
										'enctype'=>'multipart/form-data',
										'class'=>'form-horizontal',
										'id'=>'form-vendor_users_upload_csv'
									)
								); ?>
								...
								<div class="modal-body">
									...
									<ol>
										...
										<li>CSV File Upload is to update records only. No data from server will be deleted. If it is a must to delete records, go to the regular Wholesale User List <a href="<?php echo site_url($this->config->slash_item('admin_folder').'users/vendor'); ?>">here</a> and do a bulk action delete instead.</li>
