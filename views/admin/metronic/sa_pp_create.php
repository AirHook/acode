                        ...
                        <div class="col col-md-6 form-horizontal" role="form">
							...
							<div class="form-body" data-object_data='{"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"}'>
								...
								<div class="notifications">
            						...
            						<div class="alert alert-danger ">
            							<button class="close" data-close="alert"></button> Photo package was not sent. Please try again.
            						</div>
            						<?php } ?>
                                    <?php if ($this->session->flashdata('success') == 'photo_package_sent') { ?>
            						<div class="alert alert-success ">
            							<button class="close" data-close="alert"></button> Photo package sent.
            						</div>
            						<?php } ?>
                                ...
                                <div class="form-group form-group-badge select-designer-dropdown">
                                    ...
                                    <div class="col-md-7">
                                        <select class="bs-select form-control" name="des_slug" data-live-search="true" data-size="5" data-show-subtext="true" data-access_level="<?php echo $this->sales_user_details->access_level; ?>">
                                            ...
                                            <option value="<?php echo $designer->url_structure; ?>" data-subtext="<em><?php echo $designer->domain_name; ?></em>" data-des_slug="<?php echo $designer->url_structure; ?>" data-des_id="<?php echo $designer->des_id; ?>" <?php echo $designer->url_structure === $this->session->sa_pp_des_slug ? 'selected="selected"' : ''; ?>>
                                            ...
                                            <option value="<?php echo $designer->url_structure; ?>" data-subtext="<em><?php echo $designer->domain_name; ?></em>" data-des_slug="<?php echo $designer->url_structure; ?>" data-des_id="<?php echo $designer->des_id; ?>" <?php echo $designer->url_structure === $this->session->admin_sa_pp_des_slug ? 'selected="selected"' : ''; ?>>
                                                <?php echo ucwords(strtolower($designer->designer)); ?>
                                            </option>
                                        ...
                                        <input type="hidden" name="des_slug" value="<?php echo $this->session->sa_pp_des_slug ?: $this->session->admin_sa_pp_des_slug; ?>" />
                                    </div>
                                </div>
                                <!-- DOC: remove class "hide" to show div --
                                <div class="form-group form-group-badge select-preset-dropdown hide">
                                    <label class="control-label col-md-5">
                                        <span class="badge custom-badge pull-left step-load-presets step2 <?php echo ($this->session->admin_sa_pp_des_slug OR $this->session->sa_pp_des_slug) ? 'active' : ''; ?>"> 2 </span>
                                        <span class="badge-label"> Load Presets (optional) </span>
                                    </label>
                                    <div class="col-md-7 preset-dropdown-wrapper <?php echo ($this->session->admin_sa_pp_des_slug OR $this->session->sa_pp_des_slug) ? '' : 'tooltips'; ?>" data-original-title="Please select a designer first">
                                        <select class="bs-select form-control" name="preset" data-live-search="true" data-size="5" data-show-subtext="true" <?php echo ($this->session->admin_sa_pp_des_slug OR $this->session->sa_pp_des_slug) ? '' : 'disabled'; ?>>
                                            ...
                                            <option value="onsale" class="<?php echo ($this->session->admin_sa_pp_des_slug == 'tempoparis' OR $this->session->sa_pp_des_slug == 'tempoparis') ? 'hide' : ''; ?>"> OFF Price Package </option>
								...
								<div class="form-group form-group-badge">
                                    <label class="control-label col-md-5">
                                        <span class="badge custom-badge pull-left step-select_items step2 <?php echo ($this->session->admin_sa_pp_des_slug OR $this->session->sa_pp_des_slug) ? 'active' : ''; ?>"> 2 </span>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <a href="javascript:;" class="btn dark btn-md select-product-options thumbs-grid-view col-md-4" style="<?php echo ($this->session->admin_sa_pp_des_slug OR $this->session->sa_pp_des_slug) ? 'background-color:#696969;' : ''; ?>">
        								...
        								<div class="thumb-tiles">
        									...
        									if (@$products)
        									{
        										...
        										foreach ($products as $product)
        										{
        											...
        											$checkbox_check = '';
                                                    if (($key = array_search($style_no, $sa_items)) !== FALSE)
        											{
        												$classes.= 'selected';
        									...
        									<div class="thumb-tile image bg-blue-hoki <?php echo $classes.' '.$product->new_color_publish; ?> " style="<?php echo $styles; ?>">
        										...
        										<div class="" style="color:red;font-size:1rem;">
                                                    <!-- Plusbox -->
                                                    <i class="fa fa-plus package_items <?php echo $product->prod_no.'_'.$product->color_code; ?>" style="position:relative;left:5px;background:#ddd;line-height:normal;padding:1px 2px;" data-item="<?php echo $product->prod_no.'_'.$product->color_code; ?>" data-page="create"></i> &nbsp;
                                                    <!-- Checkbox --
                                                    ...
                                                    -->
                                                    <span class="text-uppercase package_items" data-item="<?php echo $product->prod_no.'_'.$product->color_code; ?>" data-page="create"> Add to Package </span>
        										</div>
                                            ...
                                            <h3 class="blank-grid-text">
                                                <em class="select-vendor"><?php echo $txt1; ?></em>
                                            </h3>
                                ...
                                <div class="form-group search-multiple-items-wrapper display-none">
                                    <div class="col-md-12 search-multiple-items">
                                        ...
                                        <div style="position:relative;">
                                        	...
                                        	<!--bof form==========================================================================-->
                                        	<?php echo form_open(
                                        		(@$role == 'sales' ? 'my_account/sales' : 'admin/campaigns').'/photo_package/search_multiple',
                                        		array(
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group form-group-badge">
                                        <label class="control-label col-md-5">
                                            ...
                                            <span class="badge-label"> Refine Photo Package </span>
                                        </label>
                                        <div class="col-md-7">
                                            <cite class="help-block font-red" style="position:relative;top:-4px;">
                                                Selected items will show in this Photo Package.
                                            </cite>
                                        </div>
                                    </div>
                                ...
                                <div class="notifications col-sm-12 clearfix">
                                    ...
                                    <div class="alert alert-danger alert-no-items display-hide" data-test="test">
                                        <button class="close" data-close="alert"></button> You have NOT selected any items for the Photo Packge. Please select now. </div>
                                    <?php if (validation_errors()) { ?>
                                    <div class="alert alert-danger">
                                        <button class="close" data-close="alert"></button> <?php echo validation_errors(); ?>
                                    </div>
                                    ...
                                    <?php if ($this->session->flashdata('success') == 'add') { ?>
                                    <div class="alert alert-success ">
                                        <button class="close" data-close="alert"></button> Photo Package successfully sent
                                    </div>
                                    <?php } ?>
                                </div>
                                ...
                                <!-- BEGIN FORM =======================================================-->
                                <?php echo form_open(
                                    (@$role == 'sales' ? 'my_account/sales' : 'admin/campaigns').'/photo_package/create',
                                    array(
                                ...
                                <input type="hidden" name="date_create" value="<?php echo time(); ?>" />
                                ...
                                <div class="col-sm-12 sa-info">
                                    ...
                                    <div class="form-body sa_info">
                                        ...
                                        <div class="form-group hide">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="sales_package_name" data-required="1" class="form-control input-sa_info" value="<?php echo @$role == 'sales' ? $this->session->sa_pp_name : $this->session->admin_sa_pp_name; ?>" placeholder="Sales Package Name" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="email_subject" data-required="1" class="form-control input-sa_info" value="<?php echo @$role == 'sales' ? @$this->session->sa_pp_email_subject : @$this->session->admin_sa_pp_email_subject; ?>" placeholder="Email Subject" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea name="email_message" class="form-control summernote input-sa_info" id="summernote_1" data-error-container="email_message_error"><?php echo @$role == 'sales' ? $this->session->s_ppa_email_message : $this->session->admin_sa_pp_email_message ?: 'Here are designs that are now available. Review them for your store.'; ?></textarea>
                                            ...
                                            <div class="col-md-10">
                                                <div class="mt-radio-list">
                                                    <div class="mt-radio-inline">
                                                        ...
                                                        {
                                                            $Y_prices = $sa_options['w_prices'] == 'Y' ? 'checked="checked"' : '';
                                                            $N_prices = $sa_options['w_prices'] == 'N' ? 'checked="checked"' : '';
                                                        }
                                                        ?>
                                    ...
                                    <div class="form-body user_details">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="hidden" name="sales_user" value="<?php echo $author_id; ?>" />
                                ...
                                <div class="col-sm-12 cart_basket_wrapper" style="margin-bottom:70px;">
                                    <div class="cart_basket">
                                        ...
                                        <?php $this->load->view('admin/metronic/sa_pp_create_items'); ?>
                                ...
                                ?>
                                <div class="col-sm-12">
                                    <div class="mt-checkbox-list hide">
                                    ...
                                    <button type="submit" class="btn dark">View and Send Photo Package</button>
                                ...
                                <div class="col-sm-12 steps">
                                    ...
                                    <div class="form-group form-group-badge clearfix" style="margin-bottom:0px;">
                                        <label class="control-label col-md-5">
                                            ...
                                            <span class="badge-label"> Send Package </span>
                                        </label>
                                        <div class="col-md-7">
                                            <cite class="help-block font-red" style="position:relative;top:-4px;">
                                                Package will be sent to users.
                                            </cite>
                                        </div>
                                    </div>

                                    <hr style="margin-top:0px;" />
                                    <a href="<?php echo site_url((@$role == 'sales' ? 'my_account/sales' : 'admin/campaigns').'/photo_package/reset'); ?>" style="color:#333;">
                                        <div class="form-group form-group-badge form-group-badge-step6 clearfix">
                                            <label class="control-label col-md-5" style="cursor:pointer;">
                                                ...
                                                <span class="badge-label"> Clear Photo Package </span>
                                            </label>
                                            <div class="col-md-7">
                                                <cite class="help-block font-red" style="position:relative;top:-4px;">
                                                    Package will be cleared of items.
                                                </cite>
                                            </div>
                                        </div>
                                    </a>
