...
if($role=='sales') { ?>
	<ul class="page-sidebar-menu   " data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200">
		...
		<li class="nav-item with-heading active">
			<a class="nav-link ">
				<span class="title uppercase">My Sales Orders</span>
				<span class="arrow open"></span>
			</a>
			<ul class="sub-menu">
				<li class="nav-item open active <?php echo $this->uri->uri_string() == 'my_account/sales/categories' ? 'active' : ''; ?>">
					<a href="<?php echo site_url('my_account/sales/listorders'); ?>" class="nav-link">
						<span class="title">List Sales Orders</span>
					</a>
				</li>
				<li class="nav-item open">
					<a href="<?php echo site_url('my_account/sales/createorder'); ?>" class="nav-link">
						<span class="title">Create Sales Order</span>
					</a>
				</li>
			</ul>
		</li>
		<li class="nav-item with-heading active">
			<a class="nav-link ">
				<span class="title uppercase">My Sales Packages</span>
				<span class="arrow open"></span>
			</a>
			<ul class="sub-menu">
				<li class="nav-item open active">
					<a href="<?php echo site_url('my_account/sales/listpackages'); ?>" class="nav-link">
						<span class="title">List Sales Packages</span>
					</a>
				</li>
				<li class="nav-item open active">
					<a href="<?php echo site_url('my_account/sales/newpackage'); ?>" class="nav-link">
		...
		<li class="nav-item with-heading active">
			<a class="nav-link ">
				<span class="title uppercase">My Wholesale Users</span>
				<span class="arrow open"></span>
			</a>
			<ul class="sub-menu">
				<li class="nav-item active open">
					<a href="<?php echo site_url('my_account/sales/listusers'); ?>" class="nav-link">
						<span class="title">List Users</span>
					</a>
				</li>
				<li class="nav-item active open">
					<a href="<?php echo site_url('my_account/sales/adduser'); ?>" class="nav-link">
