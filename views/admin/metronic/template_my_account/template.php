        ...
        <div class="wrapper">
            ...
            <header class="page-header">
                <nav class="navbar mega-menu" role="navigation">
                    <div class="container-fluid">
                        ...
                        <!-- BEGIN HEADER MENU -->
                        <div class="nav-collapse collapse navbar-collapse navbar-responsive-collapse" style="margin-top:50px;">
            ...
            <div class="container-fluid">
                <div class="page-content <?php echo @$file; ?>">
                    ...
                    if (@$file)
                    {
                        $this->load->view('my_account/'.($file ?: 'dashboard'));
                    }
                    else
                    { ?>
