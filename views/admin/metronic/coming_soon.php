...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Admin Panel | Coming Soon</title>
        ...
        <link href="<?php echo base_url('assets/metronic'); ?>/assets/pages/css/coming-soon.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 coming-soon-content">
                    <h1>Coming Soon!</h1>
                    <p> We are working on getting our website up and running. Please come back again when things have been tidied up. Might be sooner than you think. </p>
                    <br>
                    <form class="form-inline hide" action="#">
            ...
            <div class="row">
                <div class="col-md-12 coming-soon-footer"> 
					<?php echo @date('Y', @time()); ?> © <?php echo $this->webspace_details->name ?: 'Rcpixel'; ?>. | Login to Admin Panel <a href="<?php echo site_url('admin'); ?>">here.</a><br />
					<a href="<?php echo site_url(); ?>">Try again.</a>
				</div>
            </div>
        </div>
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?php echo base_url('assets/metronic'); ?>/assets/global/plugins/countdown/jquery.countdown.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo base_url('assets/custom'); ?>/js/metronic/coming-soon.js" type="text/javascript"></script>
