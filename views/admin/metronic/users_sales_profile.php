                    ...
                    <?php echo form_open(
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="admin_sales_email" data-required="1" class="form-control" value="<?php echo $this->sales_user_details->email; ?>" readonly />
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="admin_sales_user" type="text" class="form-control" value="<?php echo $this->sales_user_details->fname; ?>" readonly />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="admin_sales_lname" type="text" class="form-control" value="<?php echo $this->sales_user_details->lname; ?>" readonly />
                            ...
                            <hr />
                            <div class="form-group">
                                <div class="col-md-offset-3 col-md-4 hide">
                            ...
                            <div class="form-group hide-password">
                                ...
                                <div class="col-md-4">
                                    <input type="password" id="admin_sales_password" name="admin_sales_password" class="form-control input-password" readonly value="<?php echo $this->sales_user_details->password; ?>" />
