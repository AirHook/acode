                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light ">
								...
								<div class="portlet-body form">
									...
									<!-- FORM =======================================================================-->
									<?php echo form_open(
                                        'admin/purchase_orders/create/step1',
                                        array(
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select2me step1-select-vendor" name="vendor_id">
														...
														<option value="<?php echo $vendor->vendor_id; ?>" <?php echo set_select('vendor_id', $vendor->vendor_id, ($vendor->vendor_id === $this->session->admin_po_vendor_id)); ?> data-url_structure="<?php echo $vendor->url_structure; ?>">
                                                    ...
                                                    <input type="hidden" name="url_structure" value="<?php echo $this->session->admin_po_des_url_structure ?: ''; ?>" />
                                                </div>
                                            </div>
                                        </div>
