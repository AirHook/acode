												...
												<div>
													...
													<div class="alert alert-success auto-remove margin-bottom-10">
														<button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
														<i class="fa fa-warning fa-lg"></i> STOCKS updated!
													</div>
													<?php } ?>
												...
												<div class="row">
													 ...
													 */
													?>
													<?php if ($this->product_details->available_colors()) { ?>
														<?php foreach ($this->product_details->available_colors() as $color) { ?>
															<?php
															// set main image
															$_image_url = 
													...
													<div class="col-md-12">
														<div class="portlet box <?php echo $color->color_code == $this->product_details->primary_img_id ? 'yellow-soft' : 'grey-salsa'?>">
															...
															<div class="portlet-body">
																 ...
																 */
																?>
																<div class="row section-options" data-color_code="<?php echo $color->color_code; ?>" data-base_url="<?php echo base_url(); ?>" data-st_id="<?php echo $color->st_id; ?>" data-object_data='{"st_id":"<?php echo $color->st_id; ?>","prod_id":"<?php echo $this->product_details->prod_id; ?>","<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>","prod_no":"<?php echo $this->product_details->prod_no; ?>","color_name":"<?php echo $color->color_name; ?>"}'>
																	<div class="col-xs-12">
																		...
																		<div class="form-group">
																			...
																			<div class="col-md-8">
																				<input class="form-control form-control-inline color_date date-picker" type="text" id="stock_date-<?php echo $color->color_code; ?>" name="stock_date[<?php echo $color->st_id; ?>]" value="<?php echo $color->stock_date ?: $this->product_details->create_date; ?>" <?php echo ($this->product_details->publish === '0') ? 'disabled': ''; ?> data-initial_value="<?php echo $color->stock_date ?: $this->product_details->create_date; ?>" />
																...
																<div class="panel panel-default" data-width_stocks="<?php echo isset($color->with_stocks) ? $color->with_stocks : ''; ?>">
																	<div class="panel-heading">
																		...
																		<div class="caption">
																			...
																			<span class="caption-subject uppercase"> Stocks</span>
																		</div>
