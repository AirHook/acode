        ...
        <link href="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout4/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout4/css/themes/default.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout4/css/custom.min.css" rel="stylesheet" type="text/css" />
