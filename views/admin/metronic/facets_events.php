												<div class="col-md-4 margin-bottom-20">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<?php } ?>
															<hr />
															<p>Simlpy type in a new <?php echo @$this->webspace_details->slug == 'tempoparis' ? 'Seasons' : 'Events/Occassion'; ?> facet name and click on the button to Add New Facet. The new facet should appear in the list afterwards.</p>
														</div>
													</div>
															...
															<tr>
																...
																<th class="text-center">
																	<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
																		<input type="checkbox" id="heading_checkbox" class="group-checkable" data-set="#tbl-facets_events .checkboxes" />
																		<span></span>
																	</label>
																</th>
