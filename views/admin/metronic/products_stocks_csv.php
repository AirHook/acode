                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
									    <div class="col-md-12">
    										...
    										<?php if ($this->session->flashdata('success') == 'csv_udpated') { ?>
    										<div class="alert alert-success auto-remove">
    											<button class="close" data-close="alert"></button> Product Stocks updated through CSV.
    										</div>
    										<?php } ?>
									 ...
									 */
									?>
                                    <?php $this->load->view($this->config->slash_item('admin_folder').($this->config->slash_item('admin_template') ?: 'metronic/').'products_stocks_csv_form'); ?>
