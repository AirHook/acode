	...
	<table style="border: 1px solid #aaa;" cellspacing="0" cellpadding="0" width="100%">
		<tr><td width="100%" class="top" style="background:#F0F0F0;">
			...
			<table width="80%" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					<td class="table_title" style="background: #000000; color: #FFFFFF; font-size:24px; padding:5px 5px 5px 10px;"> <span style="font-family:'Arial Narrow';font-weight:normal;">SIGN IN &nbsp;(<span style="color:red;">ADMIN SALES ONLY</span>)</span></td>
				</tr>
				<tr>
					<td valign="middle">
						...
						<?php echo form_hidden('site_slug', $this->config->item('site_slug')); ?>
