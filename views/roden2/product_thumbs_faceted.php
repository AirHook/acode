												...
												<div class="products clearfix">
													...
													?>
														...
														foreach ($view_pane_sql->result() as $thumb):
															...
															//$img = ENVIRONMENT == 'development_' ? @GetImageSize($local_path.str_replace('/','\\',$img_thumb)) : @GetImageSize($this->config->item('PROD_IMG_URL').$img_thumb);
															//$img2 = ENVIRONMENT == 'development_' ? @GetImageSize($local_path.str_replace('/','\\',$img_thumb_back)) : @GetImageSize($this->config->item('PROD_IMG_URL').$img_thumb_back);
															//$img3 = ENVIRONMENT == 'development_' ? @GetImageSize($local_path.str_replace('/','\\',$img_thumb_side)) : @GetImageSize($this->config->item('PROD_IMG_URL').$img_thumb_side);
															/*
															if ($img)
															{
														...
														<div class="info" style="margin-top:10px;">
															...
															<ul class="swatches clearfix">
																...
																<?php if (@$colors): foreach($colors as $color): ?>
																	...
																	<?php if ($color->color_code != $thumb->primary_img_id): ?>
																...
																<li class="swatch">
																	<a class="swatch-link parent-select" href="<?php echo site_url($sub_seg); ?>" title="<?php echo ucfirst(strtolower(trim($color->color_name))); ?>">
																		<img class="swatch-image" src="<?php echo $sub_color_icon; ?>" alt="<?php echo ucfirst(strtolower(trim($color->color_name))); ?>" onmouseover="document.getElementById('<?php echo $thumb->prod_no.'_'.$color->color_code; ?>').style.display='block';" onmouseout="document.getElementById('<?php echo $thumb->prod_no.'_'.$color->color_code; ?>').style.display='none';">
																	</a>
																</li>
