					...
					<div id="header" class="header clearfix" role="banner">
						...
						<nav id="nav-primary" class="nav nav-primary" role="navigation">
                            <ul>
								<li<?php if (
									$this->uri->segment(2) == 'long_dresses' OR 
									@$product->sc_folder == 'long_dresses' OR
									@$sc_url_structure == 'long_dresses'
								) echo ' class="active_11"'; ?>>
									<a accesskey="3" href="<?php echo site_url('apparel/long_dresses'); ?>">
										Long Dresses
									</a>
								</li> 
                                <li<?php if (
									$this->uri->segment(2) == 'short_dresses' OR 
									@$product->sc_folder == 'short_dresses' OR
									@$sc_url_structure == 'short_dresses'
								) echo ' class="active_11"'; ?>>
                                    <a href="<?php echo site_url('apparel/short_dresses'); ?>" accesskey="2">
                                        Short Dresses
                                    </a>
                                </li>
                                <li<?php if (
                                    ...
                                    <a href="<?php echo site_url('apparel/jumpsuits'); ?>" accesskey="2">
                                        Jumpsuits
                                    </a>
                                </li>
						...
						<div id="nav-mobile" class="nav-mobile">
							...
							<ul>
								...
								<li class="navigation-item">
									<a href="<?php echo site_url('apparel/long_dresses'); ?>" title="Long Dresses">
										Long Dresses
									</a>
								</li>
                                <li class="navigation-item">
                                    <a href="<?php echo site_url('apparel/short_dresses'); ?>" title="Short Dresses">
                                        Short Dresses
                                    </a>
                                </li>
