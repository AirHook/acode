											...
											<div class="v-product-browsepagenavigation browse-controls clearfix">
												<div class="all"><!-- revmoving class 'viewall' -->
													 ...
													 */
													switch ($this->config->item('site_slug'))
													{
											 ...
											 */
											?>
											<div class="v-product-browsepagedisplaypreferenceform clearfix hidden">
												...
												<form id="vProduct-browsePageDisplayPreferenceForm-form-1" name="vProduct_browsePageDisplayPreferenceForm_form_1" action="" method="get" class="browse-sort">
													...
													<div class="browse-sort__dropdown">
														<select id="vProduct-browsePageDisplayPreferenceForm-size-1" name="size" class="form-submit  browse-sort__select" style="min-width:100px;">
															<option value="">
																Size
															</option>
												...
												<form id="vProduct-browsePageDisplayPreferenceForm-form-1" name="vProduct_browsePageDisplayPreferenceForm_form_1" action="" method="get" class="browse-sort">
													...
													<div class="browse-sort__dropdown">
														<select id="vProduct-browsePageDisplayPreferenceForm-color-1" name="color" class="form-submit  browse-sort__select" style="min-width:100px;">
															<option value="">
																Color
															</option>
												...
												<form id="vProduct-browsePageDisplayPreferenceForm-form-1" name="vProduct_browsePageDisplayPreferenceForm_form_1" action="" method="get" class="browse-sort">
													...
													<div class="browse-sort__dropdown">
														<select id="vProduct-browsePageDisplayPreferenceForm-occasion-1" name="occasion" class="form-submit  browse-sort__select" style="min-width:100px;">
															<option value="">
												...
												<form id="vProduct-browsePageDisplayPreferenceForm-form-1" name="vProduct_browsePageDisplayPreferenceForm_form_1" action="" method="get" class="browse-sort">
													...
													<div class="browse-sort__dropdown">
														<select id="vProduct-browsePageDisplayPreferenceForm-style-1" name="style" class="form-submit  browse-sort__select" style="min-width:100px;">
															<option value="">
																Styling
															</option>
												 ...
												 * this applicable for the hub sites like instyle
												 ...
												 <form id="vProduct-browsePageDisplayPreferenceForm-form-1" name="vProduct_browsePageDisplayPreferenceForm_form_1" action="" method="get" class="browse-sort">
													...
													<div class="browse-sort__dropdown">
														<select id="vProduct-browsePageDisplayPreferenceForm-availability-1" name="availability" class="form-submit  browse-sort__select" style="min-width:100px;">
															<option value="">
																Availability
															</option>
