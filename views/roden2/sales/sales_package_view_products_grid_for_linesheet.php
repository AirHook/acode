							...
							<div class="thumb-tiles" data-products-count="<?php echo $products_count; ?>">
								...
								if ($products) 
								{
									foreach ($products as $product) 
									{
										...
										$classes.= $batch.' ';
										$classes2 = (@$this->sales_user_details->options['selected'] && in_array($product->prod_no, $this->sales_user_details->options['selected'])) ? 'selected ' : '';
										...
										?>
											...
											<div class="product-line-item__image thumb <?php echo $classes; ?>" style="width:130px;height:auto;position:relative;<?php echo $styles; ?>">
												...
												<div style="margin-top:200px;">
													<p>
														<input type="checkbox" class="checkbox-prod_id <?php echo $classes2; ?>" name="prod_id" id="<?php echo $product->prod_id; ?>" value="<?php echo $product->prod_id; ?>" data-prod_no="<?php echo $product->prod_no; ?>" data-prod_id="<?php echo $product->prod_id; ?>" style="float:right;" <?php echo (@$this->sales_user_details->options['selected'] && in_array($product->prod_no, $this->sales_user_details->options['selected'])) ? 'checked' : ''; ?>/>
