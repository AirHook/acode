				<footer>
					...
					<ul class="footer-nav">
						<li class="ordering<?php echo ($this->uri->uri_string() == 'ordering' OR $this->uri->uri_string() == 'special_sale/ordering') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'ordering')); ?>">Ordering</a>
						</li>
						<li class="shipping<?php echo ($this->uri->uri_string() == 'shipping' OR $this->uri->uri_string() == 'special_sale/shipping') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'shipping')); ?>">Shippping</a>
						</li>
						<li class="shipping<?php echo ($this->uri->uri_string() == 'return_policy' OR $this->uri->uri_string() == 'special_sale/return_policy') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'return_policy')); ?>">Returns</a>
						</li>
						<li class="privacy_notice<?php echo ($this->uri->uri_string() == 'privacy_notice' OR $this->uri->uri_string() == 'special_sale/privacy_notice') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'privacy_notice')); ?>">Privacy</a>
						</li>
						<li class="faq<?php echo ($this->uri->uri_string() == 'faq' OR $this->uri->uri_string() == 'special_sale/faq') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'faq')); ?>">FAQ</a>
						</li>
						
						<?php if ($this->uri->segment(1) !== 'special_sale'): ?>
						
						<li class="sitemap<?php echo $this->uri->uri_string() == 'sitemap' ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'sitemap')); ?>">Sitemap</a>
						</li>
							
							<?php if ($this->config->item('site_slug') !== 'tempoparis'): ?>
							
						<li class="press<?php echo $this->uri->uri_string() == 'press' ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'press')); ?>">Press</a>
						</li>
						...
						<li class="terms_of_use<?php echo ($this->uri->uri_string() == 'terms_of_use' OR $this->uri->uri_string() == 'special_sale/terms_of_use') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'terms_of_use')); ?>">Terms Of Use</a>
						</li>
						<li class="contact<?php echo ($this->uri->uri_string() == 'contact' OR $this->uri->uri_string() == 'special_sale/contact') ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url(($this->uri->segment(1) === 'special_sale_' ? 'special_sale/' : '').'contact')); ?>">Contact</a>
						</li>
						<li class="resource<?php echo $this->uri->uri_string() == 'resource' ? ' is_active_footer_nav' : ''; ?>">
							<a href="<?php echo str_replace('https', 'http', site_url('resource')); ?>">Resource</a>
						</li>
					</ul>
					 ...
					 */
					?>
					<form id="vLayout-layout-form-1" name="vLayout_layout_form_1" action="" method="post" class="dialog footer-signup" onSubmit="ga.send('send', 'event', 'newsletter signups', 'submit', 'footer');" data-dialog='{"dialogClass": "wl-dialog--bordered", "minHeight": 180}'>
