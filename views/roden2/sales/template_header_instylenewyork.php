					...
					<div id="header" class="header clearfix" role="banner">
						...
						<nav id="nav-primary" class="nav nav-primary" role="navigation">
                            <ul>
								 ...
								 */
								?>
								<?php if ($this->uri->segment(1) === 'special_sale___' AND @$left_nav_sql->num_rows() > 0): ?>
								...
								<li>
									<a href="<?php echo site_url('special_sale'); ?>" style="color:red;" onmouseover="showObj('sub-menu-sale', this);" onmouseout="closetime();" style="cursor:default;">
							...
							<ul>
								...
								<li class="navigation-item">
									...
									<?php else: ?>
										...
										<?php if ($this->mobile_slideout_subcats->num_rows() > 0): ?>
											...
											?>
								<li class="navigation-item">
									<a href="<?php echo str_replace('https', 'http', site_url('apparel/'.$item['sc_url_structure'])); ?>" title="<?php echo $item['category_name']; ?>">
									...
									<ul>
										...
										<li class="navigation-item sub-navigation-item">
											<a href="<?php echo str_replace('https', 'http', site_url($designer)); ?>">
												 ...
												 * Designer subcats
												 */
												$slideout_des_subcats = $this->query_category->get_subcat_new('apparel', str_replace(array(' ','/'), array('_','.'), $designer));
												?>
