					...
					<div id="header" class="header clearfix" role="banner">
						...
						<nav id="nav-primary" class="nav nav-primary" role="navigation">
                            <ul>
								...
								<li<?php if (
									...
									<a onmouseover="showObj('sub-menu-tops', this);" onmouseout="closetime();" style="cursor:default;">
										Tops
									</a>
									
									<ul id="sub-menu-tops" onmouseover="cancelclosetime();" onmouseout="closetime();">
								...
								<li<?php if (
									$this->uri->segment(2) == 'bottoms' OR 
									@$product->sc_folder == 'bottoms' OR 
									@$sc_url_structure == 'bottoms'
								) echo ' class="active_11"'; ?>>
									<a onmouseover="showObj('sub-menu-bottom', this);" onmouseout="closetime();" style="cursor:default;">
										Bottoms
									</a>
								</li>
						...
						<div id="nav-mobile" class="nav-mobile">
							...
							<ul>
								...
								<li class="navigation-item">
									<a href="<?php echo str_replace('https', 'http', site_url('apparel/dresses')); ?>" title="Evening Dresses">
										Dresses
									</a>
								</li>
								<li class="navigation-item">
								...
								<li class="navigation-item">
									<a href="<?php echo str_replace('https', 'http', site_url('apparel/bottoms')); ?>" title="Skirts">
										Bottoms
									</a>
								</li>
