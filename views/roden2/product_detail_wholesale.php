									...
									<div class="productdetail product-form" style="margin-bottom:80px;">
										...
										*/
										...
										<a href="<?php echo site_url($new_url.str_replace(' ','-',strtolower(trim($this->product_details->color_name))).'/'.str_replace('/','-',str_replace(' ','-',$this->product_details->prod_name))); ?>">
											<img src="<?php echo ($this->product_details->primary_img ? $PROD_IMG_URL.$this->product_details->media_path.$this->product_details->media_name.'_c.jpg' : $PROD_IMG_URL.$img_path.'product_coloricon/'.$this->product_details->prod_no.'_'.$this->product_details->color_code.'.jpg'); ?>" width="20" style="border:1px solid #333;padding:2px;" />
										</a>
										...
										?>
											 ...
											 */
											?>
											<input type="hidden" name="prod_image_url[<?php echo $this->product_details->color_code; ?>]" value="<?php echo $this->product_details->primary_img ? $this->product_details->media_path.$this->product_details->media_name.'_f2.jpg' : ''; ?>" />
									...
									<div class="productdetail product-form" style="margin-bottom:80px;">
										...
										*/
										...
										<a href="<?php echo site_url($new_url.str_replace(' ','-',strtolower(trim($color->color_name))).'/'.str_replace('/','-',str_replace(' ','-',$this->product_details->prod_name))); ?>">
											<img src="<?php echo ($this->product_details->primary_img ? $PROD_IMG_URL.$this->product_details->media_path.$this->product_details->media_name.'_c.jpg' : $PROD_IMG_URL.$img_path.'product_coloricon/'.$this->product_details->prod_no.'_'.$color->color_code.'.jpg'); ?>" width="20" style="border:1px solid #333;padding:2px;" />
										</a>
