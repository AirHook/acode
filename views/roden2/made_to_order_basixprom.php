				...
				<div class="v-account-form clearfix">
					...
					<div class="ct ct-body clearfix">
						<p>
							...
							<p style="color:#ba6a5c;font-size:.8125rem;font-style: italic;letter-spacing:0;"><?php echo $this->config->item('site_name'); ?> respects your privacy and does not share e-mail addresses with third parties.<br /><br /></p>
						
								<button type="submit" class="button button--large button--center button--<?php echo $this->config->item('site_slug'); ?>" id="vAccount-form-submit_noPreload-1" name="submit_made_to_order">Submit</button>
