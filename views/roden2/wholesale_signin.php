									...
									<div class="col col-1of2">
										<section class="equal-height-section">
											...
											<div class="v-login-form section page-text-body">
												...
												<div id="sign-in-form" class="<?php echo isset($_SESSION['flashMsg-forgot_password']) ? 'hidden': ''; ?>">
													<div class="header-subtext header-subtext--with-border center hidden-on-mobile">
														<p><span class="subline" style="font-size:1.05rem;">Returning Customers (RETAILERS ONLY)</span></p>
														<p class="intro"><span class="subline">Sign in to place Wholesale Order.</span></p>
													</div>
													...
													<?php if ($this->session->flashdata('flashMsg')): ?>
														...
														<?php if (
															...
															&& $this->session->flashdata('flashMsg') == 'Logout successful!'
														): ?>
														
													<div class="center notice" style="<?php echo $this->webspace_details->slug == 'tempoparis' ? 'background:red;color:white;font-size:1.33em;' : 'border: 1px solid #999;background:pink;'; ?>padding:20px;">
													...
													<?php echo form_open('wholesale/authenticate'); ?>
														...
														<input type="hidden" name="site_referrer" value="<?php echo $this->webspace_details->site; ?>" />
														...
														<a class="start-page__recovery  button button--text  button--center " title="Password Recovery" onclick="$('#reset-password-form').show();$('#sign-in-form').hide();">Forgot Your Password?</a>
												...
												<div id="reset-password-form" class="<?php echo isset($_SESSION['flashMsg-forgot_password']) ? '': 'hidden'; ?>">
													<div class="header-subtext header-subtext--with-border center hidden-on-mobile">
													...
													<?php if ($this->session->flashdata('flashMsg-forgot_password')): ?>
													<div class="center notice" style="<?php echo $this->webspace_details->slug == 'tempoparis' ? 'background:red;color:white;font-size:1.33em;' : 'background:pink;'; ?>padding:20px;">
														<?php echo strtoupper($this->session->flashdata('flashMsg-forgot_password')); ?>
													</div>
													<?php endif; ?>
													...
													echo form_hidden('site_referrer', $this->webspace_details->site);
													?>
														...
														<div style="text-align:center;">
															<button type="submit" class="button button--small--text button--<?php echo $this->webspace_details->slug; ?>" style="width:200px;">Recover Password</button>
														</div>
														
														<a class="start-page__recovery  button button--text  button--center " title="Sign In Now" onclick="$('#reset-password-form').hide();$('#sign-in-form').show();">Sign In now here.</a>
									...
									<div class="col col-1of2">
										<section class="equal-height-section">
											...
											<div class="v-account-form clearfix page-text-body">
												...
												<p style="color:#ba6a5c;font-size:.75rem;font-style: italic;letter-spacing:0;"><?php echo $this->webspace_details->name; ?> respects your privacy and does not share e-mail addresses with third parties.<br /><br /></p>
											
												<div style="text-align:center;">
													<button type="submit" class="button button--small--text button--<?php echo $this->webspace_details->slug; ?>" id="vAccount-form-submit_noPreload-1" name="accountFormSubmit_noPreload" style="wodth:200px;">Create Account</button>
												</div>
