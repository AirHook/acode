					...
					<div id="header" class="header clearfix" role="banner">
						...
						<nav id="nav-primary" class="nav nav-primary" role="navigation">
                            <ul>
								...
								<li<?php if ($this->uri->segment(1) === 'designers') echo ' class="active_11"'; ?>>
									...
									<ul id="sub-menu-01" onmouseover="cancelclosetime();" onmouseout="closetime();">
										...
										<?php foreach ($this->designers_ary as $designer): ?>
											...
											<?php if ($designer !== 'shop7thavenue'): ?>
											
										<li>
											<a href="<?php echo str_replace('https', 'http', site_url($designer)); ?>">
												<?php echo ucwords(str_replace(array('_','-'), array(' ',' '), $this->query_category->designer_name(array('url_structure' => $designer)))); ?>
											</a>
										</li>
								...
								<li<?php if (
									$this->uri->segment(2) == 'novelty_sweaters' OR 
									@$product->sc_folder == 'novelty_sweaters' OR
									@$sc_url_structure == 'novelty_sweaters'
								) echo ' class="active_11"'; ?>>
								...
								<li<?php if (
									$this->uri->segment(2) == 'animal_sweaters' OR 
									@$product->sc_folder == 'animal_sweaters' OR
									@$sc_url_structure == 'animal_sweaters'
								) echo ' class="active_11"'; ?>>
								...
								<li<?php if (
									$this->uri->segment(2) == 'holiday_sweaters' OR 
									@$product->sc_folder == 'holiday_sweaters' OR 
									@$sc_url_structure == 'holiday_sweaters'
								) echo ' class="active_11"'; ?>>
								...
								<li<?php if (
									$this->uri->segment(2) == 'floral_sweaters' OR 
									@$product->sc_folder == 'floral_sweaters' OR 
									@$sc_url_structure == 'floral_sweaters'
								) echo ' class="active_11"'; ?>>
									<a href="<?php echo str_replace('https', 'http', site_url('apparel/floral_sweaters')); ?>">
										Floral Sweaters
									</a>
								</li>
								<li<?php if (
									$this->uri->segment(2) == 'southwestern_sweaters' OR 
									@$product->sc_folder == 'southwestern_sweaters' OR 
									@$sc_url_structure == 'southwestern_sweaters'
								) echo ' class="active_11"'; ?>>
									<a href="<?php echo str_replace('https', 'http', site_url('apparel/southwestern_sweaters')); ?>">
						...
						<div id="nav-mobile" class="nav-mobile">
							...
							<ul>
								...
								<li class="navigation-item">
									<a href="<?php echo site_url('apparel/novelty_sweaters'); ?>" title="Tops">
										Novelty Sweaters
									</a>
								</li>
								<li class="navigation-item">
									<a href="<?php echo site_url('apparel/animal_sweaters'); ?>" title="Sweaters">
										Animal Sweaters
									</a>
								</li>
                                <li class="navigation-item">
                                    <a href="<?php echo site_url('apparel/holiday_sweaters'); ?>" title="Dresses">
                                        Holiday Sweaters
                                    </a>
                                </li>
								<li class="navigation-item">
									<a href="<?php echo site_url('apparel/floral_sweaters'); ?>" title="Skirts">
										Floral Sweaters
									</a>
								</li>
								<li class="navigation-item">
									<a href="<?php echo site_url('apparel/southwestern_sweaters'); ?>" title="Outerwear">
										Southwestern Sweaters
									</a>
								</li>
