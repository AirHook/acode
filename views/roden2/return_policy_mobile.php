...
<tr>
	...
	<h5><a id="policy-toggle-switch" name="" style="cursor:pointer;" onclick="$('div#policy-content').show();$(this).hide();">Read more...</a></h5>
	<div id="policy-content" style="display:none;"><?php echo $row1->text; ?></div>
	</div>
	</td>
</tr>
</table>
