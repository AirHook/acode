									...
									<ul class="nav-secondary nav-content">
										...
										<?php if (@$left_nav_sql->num_rows() > 0): ?>
											...
											<?php foreach($left_nav_sql->result_array() as $item): // ---> foreach subcategory ?>
												...
												<?php if ($item['sc_url_structure'] !== 'bridal_dresses'): ?>
										
										<li class="nav-item<?php echo $item['sc_url_structure'] === $sc_url_structure ? ' active current' : ''; ?>">
											...
											<?php
											/**********
											 * We then add a link to Basix Bridal subcats pages
											 */
											?>
