							...
							<nav id="nav-primary" class="nav nav-primary" role="navigation">
								<ul>
									...
									<li class="">
										...
										?>
									<!--
									<li class="<?php if ($this->uri->segment(1) === 'designers') echo 'active_11'; ?>">
						...
						<div id="nav-mobile" class="nav-mobile">
							...
							<ul>
								...
								*/ ?>
								...
								<?php
								/**********
								 * Applying the new dynamic category tree system for mobile navigation
								 *
								 * Top browse by categories
								 */
								?>
								...
								if ($categories)
								{
									...
									foreach ($categories as $item) // ---> start category tree
									{
										...
										// close level 2
										if ($cat_level_2 == 'open' && $item->category_level == 0)
										{
											$cat_level_2 = 'close';
											$cat_level_1 = 'close';
											?>
										...
										// close level 1
										if ($cat_level_1 == 'open' && $item->category_level == 0)
										{
											$cat_level_1 = 'close';
											?>
									</ul>
								...
								<!-- start level 0 -->
								<li class="navigation-item">
									<a href="<?php echo site_url('shop/'.implode('/', $link_seg)); ?>">
										...
										// close level 0
										if ( ! $has_children && $item->category_level == 0)
										{
											?>
								</li>
											<?php
									...
									<ul>
										...
										// close level 2
										if ($cat_level_2 == 'open' && $item->category_level == 1)
										{
											$cat_level_2 = 'close';
											?>
											</ul>
										...
										// close level 1
										if ( ! $has_children && $item->category_level == 1)
										{
											?>
										</li>
											<?php
										...
										// close level 2
										if ( ! $has_children && $item->category_level == 2)
										{
											?>
												</li>
											<?php
										...
										// for continuation, stop at level 2 fro now
										// open level 3
										/*
										if ($has_children && $item->category_level == 2)
										{
									...
									<ul>
										...
										<li class="navigation-item sub-navigation-item">
											<a href="<?php echo site_url('shop/designers/'.$designer->url_structure); ?>">
												 ...
												 * Designer subcats
												 */
												$des_categories = $this->categories_tree->treelist(
													array(
											...
											<ul>
													...
													$cat_level_1 = 'close';
													$cat_level_2 = 'close';
													foreach ($des_categories as $item) // ---> foreach subcategory 
													{ 
														// set link segments
														$link_seg[$item->category_level] = $item->category_slug;
												...
												<li class="navigation-item sub-navigation-item">
													...
													<ul>
														...
														*/
														...
														// last row of record
														if ($ff == $des_number_of_categories)
														{
															if ($item->category_level == 2)
															{
																$cat_level_2 = 'close';
