								...
								<div class="nav">
									<ul class="nav-secondary nav-content">
										...
										<li class="nav-item main-nav-item designer-nav-item<?php echo ($this->uri->segment(1) == str_replace(array(' ','/'), array('_','.'), $designer->url_structure) OR $this->uri->segment(2) == str_replace(array(' ','/'), array('_','.'), $designer->url_structure)) ? ' active current' : ''; ?> <?php echo $left_nav === 'sidebar_browse_by_designer' ? '': 'hidden'; ?>">
											...
											<li class="nav-item sub-navigation-item designer-category-nav-item designer-<?php echo $designer->url_structure; ?>-nav-item <?php echo (($this->uri->segment(1) === $designer->url_structure OR $this->uri->segment(2) === $designer->url_structure) AND $item['sc_url_structure'] === $sc_url_structure) ? 'active current' : ''; ?> <?php echo ($this->uri->segment(1) === $item['d_url_structure'] OR $this->uri->segment(2) === $item['d_url_structure']) ? 'open shown': 'close hidden'; ?>">
										...
										<li class="nav-item header-nav-item">
											...
											<a href="<?php echo site_url('shop/all').'?filter=&availability=onsale'; ?>" title="Special Sale" style="cursor:pointer;color:red;">
