						...
						<nav id="nav-primary" class="nav nav-primary" role="navigation">
                            <ul>
                                <li<?php if (
                                    ...
                                    <a href="http://www.basixblacklabel.com/apparel/bridal_dresses.html" accesskey="2">
                                        Wedding Dresses
                                    </a>
                                </li>
								<li<?php if (
									$this->uri->segment(2) == 'bridesmaids_dresses' OR 
									@$product->sc_folder == 'bridesmaids_dresses' OR
									@$sc_url_structure == 'bridesmaids_dresses'
								) echo ' class="active_1"'; ?>>
									<a accesskey="3" href="http://www.basixblacklabel.com/apparel/bridesmaids_dresses.html">
										Bridesmaids
									</a>
								</li> 
								<li<?php if (
									$this->uri->segment(2) == 'maid_of_honor_dresses' OR 
									@$product->sc_folder == 'maid_of_honor_dresses' OR
									@$sc_url_structure == 'maid_of_honor_dresses'
								) echo ' class="active_1"'; ?>>
									<a accesskey="4" href="http://www.basixblacklabel.com/apparel/maid_of_honor_dresses.html">
										Maid Of Honor
									</a>
								</li> 
								<li<?php if (
									$this->uri->segment(2) == 'mother_of_bride_groom_dresses' OR 
									@$product->sc_folder == 'mother_of_bride_groom_dresses' OR
									@$sc_url_structure == 'mother_of_bride_groom_dresses'
								) echo ' class="active_1"'; ?>>
									<a accesskey="5" href="http://www.basixblacklabel.com/apparel/mother_of_bride_groom_dresses.html">
										Mother Of The Bride
									</a>
								</li> 
						...
						<div id="nav-mobile" class="nav-mobile">
							...
							<ul>
                                ...
                                <li id="book-an-appointment">
									<a href="http://www.basixblacklabel.com/apparel/bridal_dresses.html" title="Bridal Dresses">
                                        Bridal Dresses
                                    </a>
									
									<!-- Place the resulting style facets here -->
									<?php //echo @$this->facets->show_roden_sidebar_styles_facets($this->set->get_facets('styles', '155', '57', ''), 'styles', 'bridal_dresses'); // (facet, subcat, des, filter) ?>
									
                                </li>
								<li class="navigation-item">
									<a href="http://www.basixblacklabel.com/apparel/bridesmaids_dresses.html" title="Bridesmaids">
										Bridesmaids
									</a>
									
									<!-- Place the resulting style facets here -->
									<?php //echo @$this->facets->show_roden_sidebar_styles_facets($this->set->get_facets('styles', '156', '57', ''), 'styles', 'bridesmaids_dresses'); // (facet, subcat, des, filter) ?>
									
								</li>
								<li class="navigation-item">
									<a href="http://www.basixblacklabel.com/apparel/maid_of_honor_dresses.html" title="Maid Of Honor">
										Maid Of Honor
									</a>
									
									<!-- Place the resulting style facets here -->
									<?php //echo @$this->facets->show_roden_sidebar_styles_facets($this->set->get_facets('styles', '157', '57', ''), 'styles', 'maid_of_honor_dresses'); // (facet, subcat, des, filter) ?>
									
								</li>
								<li class="navigation-item">
									<a href="http://www.basixblacklabel.com/apparel/mother_of_bride_groom_dresses.html" title="Mother Of The Bride">
										Mother Of The Bride
									</a>
									
									<!-- Place the resulting style facets here -->
									<?php //echo @$this->facets->show_roden_sidebar_styles_facets($this->set->get_facets('styles', '158', '57', ''), 'styles', 'mother_of_bride_groom_dresses'); // (facet, subcat, des, filter) ?>
								...
								<li class="navigation-item">
									<a href="<?php echo site_url('events'); ?>" title="Shows &amp; Events">
										Shows &amp; Events
									</a>
								</li>
								<li class="navigation-item">
