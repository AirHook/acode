					...
					<div id="header" class="header clearfix" role="banner">
						...
						<nav id="nav-primary" class="nav nav-primary" role="navigation">
                            <ul>
								...
								<li<?php if ($this->uri->segment(1) === 'designers') echo ' class="active_11"'; ?>>
									<a href="<?php echo site_url('designers'); ?>" onmouseover="showObj('sub-menu-01', this);" onmouseout="closetime();" style="cursor:default;">
										All Designers
									</a>
									...
									<ul id="sub-menu-01" onmouseover="cancelclosetime();" onmouseout="closetime();">
										...
										<li>
											<a href="<?php echo site_url($designer->url_structure); ?>">
						...
						<div id="nav-mobile" class="nav-mobile">
							<div class="mobile-nav-top">
									...
									<a href="<?php echo site_url('apparel'); ?>" title="Shop By Category">
							...
							<ul>
								...
								<li class="navigation-item">
									<a href="<?php echo site_url('apparel'); ?>" title="Regular Items">
                                ...
                                <li class="navigation-item">
                                    <a href="<?php echo site_url('apparel/bridal_dresses'); ?>" title="Wedding Dresses">
                                        Wedding Dresses
                                    </a>
								...
								<li class="navigation-item">
									<a href="<?php echo site_url('designers'); ?>" title="Shop By Designer">
									...
									<ul>
										...
										<li class="navigation-item sub-navigation-item">
											<a href="<?php echo site_url($designer); ?>">
