...
<html lang="en" class="no-js">
    ...
    <head>
		...
		<title>
			<?php echo @$site_title ? $this->webspace_details->name.' | '.$site_title : $this->webspace_details->site_title; ?>
		</title>
		...
		<!--[if lte IE 8]>
			<link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url('assets/themes/roden2'); ?>/css/ie-min.css" />
		<![endif]-->
		 ...
		 * Search Autocomplete script
			...
			<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/themes/roden2/custom'); ?>/jscript/jquery-autocomplete/jquery.autocomplete.css" />
			<script type="text/javascript" src="<?php echo base_url('assets/themes/roden2/custom'); ?>/jscript/jquery-autocomplete/jquery.autocomplete.min.js"></script>
			<script type="text/javascript">
				jQuery(document).ready(function ($) {
					$("#search_by_style").autocomplete("<?php echo base_url('assets/themes/roden2/custom'); ?>/jscript/jquery-autocomplete/get_style_list.php", {
						width: 158,
						matchContains: true,
						max: 20,
						selectFirst: false
					});
					$("#search_by_style_mobile_nav").autocomplete("<?php echo base_url('assets/themes/roden2/custom'); ?>/jscript/jquery-autocomplete/get_style_list.php", {
						width: 158,
						matchContains: true,
						max: 20,
						selectFirst: false
		...
		<script type="text/javascript">
			jQuery(document).ready(function ($) {
				...
				var custom = new Bloodhound({
					...
					remote: {
						url: '<?php echo base_url(); ?>search/suggestions/index/%QUERY',
						wildcard: '%QUERY'
					}
				});
		...
		<?php
		/*****
		 * Video JS to help play FLV files
		 * Discovered this js plugin from stackoverflow
		 * Link: https://stackoverflow.com/questions/2248800/play-flv-in-html
		 * Documentation: http://docs.videojs.com/tutorial-embeds.html
		 *
		 * Saved the CDN (as of 20180405) just to preserve playability in case CDN get's updated
		<link href="http://vjs.zencdn.net/c/video-js.css" rel="stylesheet">
		<script src="http://vjs.zencdn.net/c/video.js"></script>
		
		<link href="<?php echo base_url(); ?>assets/custom/js/video-js/video-js.css" rel="stylesheet" type="text/css" />
		<script src="<?php echo base_url(); ?>assets/custom/js/video-js/video.js" type="text/javascript"></script>
		
		 * But because of <video> for HTML5, with it's ability for cross browser compatibility
		 * we are converting all FLV videos to HTML5 MP4 instead
		 */
		?>
		...
		<?php 
			...
			)
			{
				...
				echo '<link href="'.base_url('assets/themes/roden2/custom').'/styles/cloud-zoom.css" rel="stylesheet" type="text/css">';
		...
		<style>
			...
			/*body, button, .button { font-family: 'Helvetica', 'Arial', sans-serif; }*/
		</style>
