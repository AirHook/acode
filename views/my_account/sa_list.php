...
<div class="table-toolbar">
	...
	<ul class="nav nav-tabs">
		<li class="/my_account/sales/listpackages">
			<a href="<?php echo site_url('my_account/sales/listpackages'); ?>">
				Sales Packages
			</a>
		</li>
		...
		{ ?>
		<li>
			<a href="<?php echo site_url('my_account/sales/newpackage'); ?>">
...
<table class="table table-striped table-bordered table-hover table-checkable order-column" id="tbl-sales_packages">
	...
	<tbody>
		...
		if ($packages)
		{
			...
			{
				$edit_link = site_url('my_account/sales/listpackages/modify/index/'.$package->sales_package_id);
				...
				<div class="btn-group hide" >
					...
					<ul class="dropdown-menu pull-right">
						<li>
							...
							<a href="#modal-select_designer_for_designer_recent_sales_package" data-toggle="modal">
							<?php } else { ?>
							<a href="<?php echo site_url('my_account/sales/listpackages/edit/step1/'.$package->sales_package_id); ?>">
							<?php } ?>
								<i class="icon-pencil"></i> View/Modify </a>
						</li>
						<?php if ($package->sales_package_items != '') { ?>
						<li>
							<a href="<?php echo site_url('my_account/sales/listpackages/send/index/'.$package->sales_package_id); ?>">
								<i class="icon-paper-plane"></i> Send </a>
						</li>
							<?php if ($package->set_as_default !== '1' && $package->sales_package_id !== '2') { ?>
						<li class="hide">
							<a href="<?php echo site_url('my_account/sales/listpackages/set_as_default/index/'.$package->sales_package_id); ?>">
					...
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="<?php echo 'my_account/sales/listpackages/delete/index/'.$package->sales_package_id; ?>" type="button" class="btn green mt-ladda-btn ladda-button" data-style="expand-left">
