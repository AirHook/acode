                    ...
                    <div class="table-toolbar">
                        <ul class="nav nav-tabs">
                            <li class="<?php echo $this->uri->segment(3) == 'orders' ? 'active' : ''; ?>">
                    ...
                    <div class="row ">
						...
						<?php echo form_open('my_account/orders/details/'.$this->order_details->order_id, array('class'=>'form-horizontal', 'id'=>'form-orders_details')); ?>
								...
								<div class="portlet-title">
									...
									<div class="actions">
										<div class="btn-group btn-group-devided">
											<a class="btn btn-secondary-outline" href="<?php echo site_url('my_account/'.$role.'/orders'); ?>">
												<i class="fa fa-reply"></i> Back to order list</a>
											<?php
											if ($this->order_details->remarks != '0' && $this->order_details->remarks != '') $return = TRUE;
											else $return = FALSE;
											?>
											<label class="btn btn-transparent blue btn-outline btn-circle btn-sm <?php echo ( ! $return && $this->order_details->status == '0') ? 'active': 'tooltips'; ?>" <?php echo ( ! $return && $this->order_details->status == '0') ? '': 'data-toggle="modal" data-target="#modal-pending" data-container="body" data-original-title="Set as Pending"'; ?>>Pending</label>
										</div>
									</div>
								</div>
