<div class="table-toolbar">
	<div class="row">
		...
		<div class="col-md-6">
			...
			<!-- BEGIN FORM-->
			<!-- FORM =======================================================================-->
			<?php echo form_open('my_account/sales/listusers/search', array('class'=>'form-horizontal', 'id'=>'form-wholesale_users_search_email')); ?>
...
// echo form_open(
	// (
		...
		// : 'my_account/sales/listusers/bulk_actions'
	// ),
	// array(
...
<div class="nortifications">
	...
	<div class="alert alert-danger ">
		<button class="close" data-close="alert"></button> The Recent Items Sales Package is outdated. Please update the Recent Items Sales Package <a href="<?php echo site_url($this->config->slash_item('admin_folder').'campaigns/sales_package/edit/1'); ?>">here</a>.
	</div>
	<?php } ?>
...
<div class="table-toolbar">
	...
	<ul class="nav nav-tabs">
		...
		{ ?>
		<li>
			<a href="<?php echo site_url('my_account/sales/adduser'); ?>">
...
<table class="table table-striped table-bordered table-hover order-column dt-responsive" width="100%" id="tbl-users_wholesale_">
	...
	<tbody>
		...
		if ($users)
		{
			...
			{
				$edit_link = site_url('my_account/sales/listusers/edit/'.$user->user_id); ?>
					...
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="<?php echo site_url('my_account/sales/listusers/send_package/index/'.$user->user_id.'/'.$this->uri->segment(4)); ?>" type="button" class="btn green mt-ladda-btn ladda-button" data-style="expand-left">
					...
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="<?php echo site_url('my_account/sales/listusers/suspend/index/'.$user->user_id.'/'.$this->uri->segment(4)); ?>" type="button" class="btn green mt-ladda-btn ladda-button" data-style="expand-left">
				...
				<div class="modal fade bs-modal-sm" id="set-inactive-<?php echo $user->user_id?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
								<a href="<?php echo site_url('my_account/sales/listusers/deactivate/index/'.$user->user_id.'/'.$this->uri->segment(4)); ?>" type="button" class="btn green mt-ladda-btn ladda-button" data-style="expand-left">
									<span class="ladda-label">Confirm?</span>
									<span class="ladda-spinner"></span>
								</a>
							</div>
				...
				<div class="modal fade bs-modal-sm" id="activate-<?php echo $user->user_id?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
								<a href="<?php echo site_url('my_account/sales/listusers/activate/index/'.$user->user_id.'/'.$this->uri->segment(4)); ?>" type="button" class="btn green mt-ladda-btn ladda-button" data-style="expand-left">
									<span class="ladda-label">Confirm?</span>
									<span class="ladda-spinner"></span>
								</a>
							</div>
				...
				<div class="modal fade bs-modal-sm" id="delete-<?php echo $user->user_id?>" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog modal-sm">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
								<a href="<?php echo site_url('my_account/sales/listusers/delete/index/'.$user->user_id.'/'.$this->uri->segment(4)); ?>" type="button" class="btn green mt-ladda-btn ladda-button" data-style="expand-left">
									<span class="ladda-label">Confirm?</span>
									<span class="ladda-spinner"></span>
								</a>
							</div>
