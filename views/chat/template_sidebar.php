                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu page-sidebar-menu-closed page-header-fixed " data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                                ...
                                <form class="sidebar-search  sidebar-search-bordered" action="" method="POST">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <a href="javascript:;" class="btn submit disabled-link disable-target">
                            ...
                            <li class="nav-item start <?php echo $this->uri->uri_string() == 'chat' ? 'active': '';?>">
                                <a href="<?php echo site_url('chat'); ?>" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">Chat Boards</span>
									<?php echo $this->uri->uri_string() == 'chat' ? '<span class="selected"></span>': '';?>
                                </a>
                            </li>
