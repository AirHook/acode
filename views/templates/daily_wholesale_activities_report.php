...
<body yahoo style="margin: 0;padding: 0; min-width: 100% !important; font-family: verdana; font-size: 12px;">
	...
	<table style="font-size:12px;padding:0 0 20px 30px;">
		...
		<tr>
			<td style="padding:0 0 20px 30px;">
				<br />
					Click <a href="<?php echo site_url('admin/campaigns/sales_package/create/by_product_clicks_report'); ?>?date=<?php echo $wholesale_user->xdate; ?>&user=<?php echo $wholesale_user->email; ?>">HERE</a> to send this user an <strong>OFFER TO PURCHASE</strong> items clicked.
			</td>
		</tr>
