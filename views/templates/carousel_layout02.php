			...
			<table class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 625px;">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr bgcolor="white">
                                <td align="center" colspan="3" style="padding-top:30px;font-family:Arial;font-size:12px;color:black;">
                                    ...
                                    <img src="<?php echo base_url(); ?>assets/images/logo/logo-<?php echo @$designers[0] ?: $this->webspace_details->slug; ?>.png" width="300" style="margin-top:10px;margin-bottom:5px;" />
							...
							<tr bgcolor="white" style="">
    								...
    								$ii = 0; // items count
                                    if (@$products[$designers[0]])
                                    {
        								foreach($products[$designers[0]] as $item)
        								{
        									// get product details
                                            ...
                                            // access link
                                            $access_link = base_url().'sales_package/link/index/X/0/'.$tc.'.html?email='.($test_email ?: '%recipient_email%').'&items_csv='.$items_csv[$designers[0]];
        									?>
                ...
                <tr>
					<td class="" bgcolor="" style="padding-bottom:50px;">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr bgcolor="white">
                                <td align="center" colspan="3" style="padding:30px 0;font-family:Arial;font-size:12px;color:black;">

                                    <img src="<?php echo base_url(); ?>assets/images/logo/logo-<?php echo @$reference_designer ?: $this->webspace_details->slug; ?>.png" width="300" style="margin-top:10px;margin-bottom:5px;" />
