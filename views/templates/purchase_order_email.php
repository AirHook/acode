								...
								<tr bgcolor="">
									...
									<td width="100%" height="92" align="center" style="font-family:Tahoma;font-size:12px;color:black;vertical-align:top;">
										...
										<span style="font-size:0.8em;line-height:24px;">
											Please Accept PO by return reply
										</span>
										<br />
										<br />
						...
						<td>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
								...
								<tr>
									...
									<td style="border:1px solid #ccc;height:24px;padding-left:5px;"> <?php echo $po_details->delivery_date; ?>
									</td>
									<td style="border:1px solid #ccc;height:24px;padding-left:5px;"> <?php echo @$po_options['ship_via']; ?>
									</td>
									<td style="border:1px solid #ccc;height:24px;padding-left:5px;"> <?php echo @$po_options['fob']; ?>
									</td>
									<td style="border:1px solid #ccc;height:24px;padding-left:5px;"> <?php echo @$po_options['terms']; ?>
									</td>
								</tr>
							</table>
							...
							<table cellpadding="0" cellspacing="0" style="width:100%;vertical-align:top;">
								...
								<tr>
									 ...
									 */
									?>
									<td valign="top" style="padding-bottom:20px;vertical-align:top;">
