			...
			<table class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 625px;">
				...
				<tr>
					<td class="innerpadding borderbottom" style="padding: 30px 0; border-bottom: 1px solid #f2eeed;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="message-to-user" style="color:#153643;font-family:sans-serif;font-size:16px;line-height:22px;">
                                    <?php
                                    if (@$message)
                                    {
                                        echo $message;
                ...
                <?php if (@$designers)
                {
                    foreach ($designers as $designer)
                    {
                        ...
                        {
                            $designer_details = $this->designer_details->initialize(array('url_structure'=>$designer));
                            $designer_name = $designer_details->designer;
                            $designer_slug = $designer_details->slug;
                        }
                        else
                        {
                            $designer_name = $designer->designer;
                            $designer_slug = $designer->url_structure;
                        }
                        ?>

				<tr>
					<td class="" bgcolor="" style="padding-bottom:30px;">

						<table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr bgcolor="white">
                                <td align="center" colspan="3" style="padding:30px;font-family:Arial;font-size:12px;color:black;">

                                    <img src="<?php echo base_url(); ?>assets/images/logo/logo-<?php echo $designer_slug ?: $this->webspace_details->slug; ?>.png" width="300" height="50" alt="<?php echo $designer_name; ?>" style="margin-top:10px;margin-bottom:5px;font-size:50px;font-family:'Arial Narrow';color:#555;" />
							...
							<tr bgcolor="white" style="">
    								...
    								$ii = 0; // items count
                                    if (@$products[$designer])
                                    {
        								foreach($products[$designer] as $item)
        								{
        									// get product details
