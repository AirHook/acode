						...
						<tbody>
							<tr>
								...
								foreach($items as $product)
								{
									...
									// the color icon
									$color_icon = $this->product_details->prod_no.'_'.$this->product_details->primary_img_id.'.jpg';

									// the new way relating records with media library
									$new_pre_url =
										$this->config->item('PROD_IMG_URL')
										.$this->product_details->media_path
										.$this->product_details->media_name
									;
								...
								<td style="vertical-align:top;width:154px">
									<a href="<?php echo $access_link ?: $this->config->item('PROD_IMG_URL').'wholesale/signin.html'; ?>" style="text-decoration:none;margin:0;padding:0;color:inherit;display:inline-block;">
										<div id="spthumbdiv_<?php echo $product; ?>" class="fadehover" style="width:140px;height:210px;">
											<img src="<?php echo $this->product_details->primary_img ? $img_front_new : $img_front_pre.$image; ?>" alt="<?php echo $this->product_details->prod_no; ?>" title="<?php echo $this->product_details->prod_no; ?>" border="0" width="140" style="width:140px;">
										</div>
									</a>
									<div style="margin:3px 0 0;">
										<img src="<?php echo ($this->product_details->primary_img ? $img_coloricon : $color_icon_pre.$color_icon); ?>" width="10" height="10">
									</div>

									<div style="width:140px;">
										<span style="font-size:10px;"><?php echo $this->product_details->prod_no; ?></span>
										<?php if ($w_prices == 'Y') { ?>
										<br />
										<span style="font-size:10px;">
											$ <?php echo number_format(@$this->sales_package_details->prices[$this->product_details->prod_no] ?: $this->product_details->wholesale_price, 2); ?>
										</span>
										<?php } ?>
									</div>
								</td>
