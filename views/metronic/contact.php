												...
												<div class="col-sm-5">
													...
													<div class="contact-methods clearfix">
														...
														<p>
                                                            ...
                                                            {
                                                                $conatct_email = 'tempoparis@verizon.net';
                                                            }
                                                            else $conatct_email = $this->webspace_details->info_email;
                                                            ?>
															To contact us via email, complete the fields to the left, or write us at <?php echo safe_mailto($conatct_email); ?>
														</p>

														<h4 style="border-bottom:1px solid #ccc;text-transform:uppercase;">Support</h4>
														<p>
															Sales and Customer Support is available 7am – midnight EST, seven days a week: <?php echo safe_mailto($conatct_email); ?>
														</p>

                                                        <?php if ($this->webspace_details->slug === 'tempoparis')
                                                        { ?>

                                                            <h4 style="border-bottom:1px solid #ccc;text-transform:uppercase;">Mail</h4>
    														<p>
                                                                TEMPO PARIS<br/>
                                                                241 West 37th Street<br />
                                                                New York, NY 10018
    														</p>
