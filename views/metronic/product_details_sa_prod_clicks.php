                                    ...
                                    <div class="page-content-inner">
										...
										<div class="product-details-wrapper">
                                            ...
                                            foreach ($sa_items as $item)
                                            {
                                                ...
                                                $img_back_new = $this->config->item('PROD_IMG_URL').$product->media_path.$style_no.'_b.jpg';
                                                $img_side_new = $this->config->item('PROD_IMG_URL').$product->media_path.$style_no.'_s.jpg';
