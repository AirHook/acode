										...
										<div class="thumb-tiles" data-row-count="<?php echo $products_count; ?>">
											...
											if ($products)
											{
												...
												foreach ($products as $product)
												{
													...
													$checkbox_check = '';
													if (in_array($style_no, $sa_items))
													{
														$classes.= 'selected';
														$checkbox_check = 'checked';
													}
													if (
														in_array($product->prod_no, $sa_items)
											...
											<div class="thumb-tile image bg-blue-hoki <?php echo $classes; ?>" style="<?php echo $styles; ?>">
												...
												<div class="" style="color:red;">
													Add to package:
													<input type="checkbox" class="package_items" name="prod_no[]" value="<?php echo $product->prod_no.'_'.$product->color_code; ?>" style="float:right;" data-object_data='{"<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"}' <?php echo $checkbox_check; ?> />
												</div>
