											...
											<div class="row">
                                                ...
                                                <div class="col-sm-12 sales_user_details">
                                                    <p>
        												 ...
        												 */
        												?>
                                                        Ordered by: &nbsp;<?php echo $author->fname.' '.$author->lname; ?> (<?php echo safe_mailto($author->email); ?>)
                                                    </p>
                                                </div>

                                                <!-- BEGIN FORM =======================================================-->
                                                <?php echo form_open(
                                                    'sales/purchase_orders/modify/index/'.$this->purchase_order_details->po_id,
                                                    array(
																...
																<tbody>
																	...
																	<tr class="summary-item-container">
																		...
																		<td class="size-and-qty-wrapper">
                                                                            ...
                                                                            <div style="display:inline-block;">
                                                                                <?php echo $s; ?> <br />
                                                                                <select name="<?php echo $size_label; ?>" class="size-select" style="border:1px solid #<?php echo $size_qty > 0 ? '000' : 'ccc'; ?>;" data-page="modify" data-prod_no="<?php echo $item; ?>" data-vendor_price="<?php echo @$product->vendor_price; ?>">
                                                                                    <?php
                                                                                    for ($i=0;$i<31;$i++)
                                                                                    {
                                                                                        echo '<option value="'.$i.'" '.($i == $size_qty ? 'selected' : '').'>'.$i.'</option>';
