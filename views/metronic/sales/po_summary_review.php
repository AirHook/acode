												...
												<div class="col-sm-12 po-summary-addresses">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
															...
															<h5> SHIP TO
                                                                <a href="#modal-edit_ship_to" data-toggle="modal" class="small ship-to-popovers popovers" data-trigger="hover" data-placement="top" data-container="body" data-content="Click here to change 'Ship To' address. Reset to return to default." data-original-title="EDIT Shipt To" style="margin-left:10px;"> edit </a> <small>/</small> <a href="<?php echo site_url('sales/purchase_orders/create/reset_ship_to'); ?>" class="small"> reset </a>
                                                            </h5>
                                    		...
                                    		<div class="modal fade" id="modal-edit_ship_to" tabindex="-1" role="basic" aria-hidden="true">
                                    			<div class="modal-dialog">
                                    				<div class="modal-content">
                                    					...
                                    					<!-- FORM =======================================================================-->
                                    					<?php echo form_open(
                                    						'sales/purchase_orders/edit_ship_to',
                                    						array(
                                    							'id'=>'form-seletc_user'
                                    						)
                                    					); ?>
