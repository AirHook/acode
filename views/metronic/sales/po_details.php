                                    ...
                                    <div class="row">
                                        ...
                                        <div class="portlet solid " style="padding-right:15px;">
                                            <div class="portlet-title">
                                                ...
                                                <div class="caption">
                                                    <a class="btn dark " href="<?php echo site_url('sales/purchase_orders/modify/index/'.$po_details->po_id); ?>">
                                                ...
                                                <div class="actions btn-set">
                                                    ...
                                                    &nbsp;
                                                    <a class="btn dark " href="<?php echo site_url('sales/purchase_orders/create/send/'.$po_details->po_id); ?>">
