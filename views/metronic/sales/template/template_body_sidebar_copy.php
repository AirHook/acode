                                                ...
                                                <div class="clearfix">
                                                    <div class="col-md-12 margin-bottom-10">
                                                        ...
                                                        <?php } elseif (@$steps == 2 && $cart_nav_items_count > 0) { ?>
                                                            <a href="<?php echo site_url('sales/'.($this->uri->segment(2) == 'purchase_orders' ? 'puchase_orders/' : '').'create/step3'); ?>" class="btn btn-default btn-block btn-sm sidebar-send-package-btn" data-original-title="Nothing to send">
                                                                <span style="color:red;">
                                                                    <?php
                                                                    echo $this->uri->segment(2) == 'purchase_orders'
                                                                        ? 'REFINE PURCHASE ORDER'
                                                    ...
                                                    <div class="col-md-12 margin-bottom-10">
                                                        <a class="btn btn-default btn-block btn-sm" href="<?php echo site_url('sales/create/step1/womens_apparel'); ?>"> ADD MORE ITEMS </a>
                                                    </div>
                                                    <div class="col-md-12 margin-bottom-10">
