                            ...
                            <div class="container">
                                ...
                                <div class="hor-menu  ">
                                    <ul class="nav navbar-nav">
																	...
																	<div class="col-md-3 margin-bottom-30">
																		...
																		<ul class="mega-menu-submenu">
																			...
																			<li aria-haspopup="true" class="<?php echo $this->uri->uri_string() == 'shop/'.$designer->url_structure.'/womens_apparel/'.$des_subcat->category_slug ? 'active' : ''; ?>">
																				<a href="<?php echo site_url('shop/'.$designer->url_structure.'/womens_apparel/'.$des_subcat->category_slug); ?>" class="nav-link " onmouseover="$('.hover-icon').fadeOut();$('.hover-icon.<?php echo $designer->url_structure.'-'.$des_subcat->category_slug; ?>').fadeIn();">
                                        ...
                                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown">
                                            <a class="margin-right-0" href="<?php echo $this->config->item('PROD_IMG_URL'); ?>shop/womens_apparel.html?filter=&availability=onsale"> Special Sale
                                                <span class="arrow hide"></span>
                                            </a>
                                        </li>
                                    </ul>
