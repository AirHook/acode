...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Shop 7th Avenue | Welcome</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Shop 7th Avenue" name="description" />
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="page-logo">
                                    <a href="index.html">
										...
										<img src="<?php echo base_url().$this->webspace_details->options['logo']; ?>" alt="logo" class="logo-default" />
										<?php } else { ?>
										<!--<img src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" />-->
										<img src="<?php echo base_url(); ?>assets/images/logo/logo-shop7thavenue.png" alt="logo" height="25px" class="logo-default" />
										<?php } ?>
                                    </a>
                                </div>
                                <!-- END LOGO -->
                                ...
                                <div class="top-menu">
                                    <ul class="nav navbar-nav pull-right">
                                                ...
                                                <li>
                                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                                        <li>
                                                            <a href="#">
                                                                <span class="photo">
                                                                    <img src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                                <span class="subject">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <span class="photo">
                                                                    <img src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                                <span class="subject">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <span class="photo">
                                                                    <img src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                                                <span class="subject">
                                        ...
                                        <li class="dropdown dropdown-user dropdown-dark">
                                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                                <img alt="" class="img-circle" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout3/img/avatar9.jpg">
                                        ...
                                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                            ...
                                            <ul class="media-list list-items">
                                                <li class="media">
                                                    ...
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                                ...
                                                <li class="media">
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                                    <div class="media-body">
                                            ...
                                            <ul class="media-list list-items">
                                                <li class="media">
                                                    ...
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <img class="media-object" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                                    <div class="media-body">
                                        ...
                                        <div class="page-quick-sidebar-item">
                                            <div class="page-quick-sidebar-chat-user">
                                                ...
                                                <div class="page-quick-sidebar-chat-user-messages">
                                                    <div class="post out">
                                                        <img class="avatar" alt="" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar3.jpg" />
                                                        <div class="message">
                                                            <span class="arrow"></span>
                                                    ...
                                                    <div class="post in">
                                                        <img class="avatar" alt="" src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout/img/avatar2.jpg" />
                                                        <div class="message">
                                                            <span class="arrow"></span>
...
<![endif]-->
        ...
        <script src="<?php echo base_url('assets/metronic'); ?>/assets/layouts/layout3/scripts/layout.min.js" type="text/javascript"></script>
