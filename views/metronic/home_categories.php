                                        ...
                                        <div class="portfolio-content portfolio-3 margin-top-30">
                                            ...
                                            <div id="js-grid-lightbox-gallery" class="cbp">
												...
												foreach ($categories as $category)
												{
													...
													{
                                                        // non numeric key indicates data is now an associative array
														$key = is_numeric(array_search($this->webspace_details->slug, $linked_designers)) ? array_search($this->webspace_details->slug, $linked_designers) + 1 : FALSE;
