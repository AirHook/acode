...
class Designers extends Shop_Controller
{
	...
	function index()
	{
		// if ws user reference_designer is instyle or shop7 or any hub_site for that matter
		// hard coded for now
		if (
			$this->session->user_role == 'wholesale'
			&& (
				@$this->wholesale_user_details->reference_designer == 'instylenewyork'
				OR @$this->wholesale_user_details->reference_designer == 'shop7thavenue'
			)
		)
		{
			// redirect to original home page instead of this designer icons page controller
