			...
			if ($this->session->user_loggedin)
			{
				if ($this->session->user_cat == 'wholesale')
				{
					...
					$newdata = array(
						...
						'sh_email' 				=> $this->wholesale_user_details->email,
						'sh_firstname'			=> $this->wholesale_user_details->fname,
						'sh_lastname'			=> $this->wholesale_user_details->lname,
						'sh_phone'				=> $this->wholesale_user_details->telephone,
						'sh_address1'			=> $this->wholesale_user_details->address1,
						'sh_address2'			=> $this->wholesale_user_details->address2,
						'sh_country'			=> $this->wholesale_user_details->country,
						'sh_city'				=> $this->wholesale_user_details->city,
						'sh_state'				=> $this->wholesale_user_details->state,
						'sh_zip'				=> $this->wholesale_user_details->zipcode,
						'agree_to_policy'		=> '1'
					);
