...
class Index extends Admin_Controller {
	...
	public function index()
	{
		...
		// set data variables...
		$this->data['file'] = 'users_vendor_types';
		$this->data['page_title'] = 'Vendor Types';
		$this->data['page_description'] = 'List of vendor types';
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_scripts'] = '';
			...
			// handle datatable
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/table-datatables-users_vendor_types_list.js" type="text/javascript"></script>
			';
	}
