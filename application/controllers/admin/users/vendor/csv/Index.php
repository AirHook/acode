...
class Index extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->data['users'] = $this->vendor_users_list_csv->select($params);
		...
		$this->data['show_loading'] = $this->vendor_users_list_csv->row_count > 200 ? TRUE : FALSE;
		
		// set data variables...
		$this->data['file'] = 'users_vendor_csv';
		$this->data['page_title'] = 'Vendor Users CSV';
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_scripts'] = '';
			...
			// handle datatable
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/table-datatables-users_vendor_list_csv.js" type="text/javascript"></script>
			';
	}
