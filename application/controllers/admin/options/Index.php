...
class Index extends Admin_Controller {
	...
	public function index()
	{
		...
		// options
		$this->data['shipmethods'] = $this->DB->get('tbl_shipmethod')->result();

		// default display
		$this->data['active_option_tab'] = $this->session->userdata('active_option_tab') ?: 'shipmethod';

		// set data variables...
		$this->data['file'] = 'options';
		$this->data['page_title'] = 'Options';
		$this->data['page_description'] = 'List of Options';
