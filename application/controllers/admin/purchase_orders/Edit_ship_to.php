...
class Edit_ship_to extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->session->set_userdata('admin_po_store_id', $user_details->user_id);

		redirect('admin/purchase_orders/create/step3', 'location');
	}
