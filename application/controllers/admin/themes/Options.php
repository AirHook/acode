...
class Options extends Admin_Controller {
	...
	public function index()
	{
		...
		/***********
		 * Roden template old template index page requires access to db due to
		 * sliders/graphics accessed on homepage options for the template
		 * We put the DB object in a variable.
		 * However, to the updated Roden2, we remove DB accesses on view files
		 */
		...
		// set data variables...
		$this->data['file'] = 'themes_options';
		$this->data['page_title'] = 'Theme Options';
		$this->data['page_description'] = $this->webspace_details->theme_name ? $this->webspace_details->theme_name.' theme.' :'&nbsp;';
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_styles'] = '';
			...
			if (@$this->webspace_details->options['theme'] == 'roden2')
			{
				...
				$this->data['page_level_styles'].= '
					<link href="'.base_url().'assets/themes/roden2/css/home_image_boxes_styles.css" rel="stylesheet" type="text/css" />
				';
			}
		...
		$this->data['page_level_scripts'] = '';
			...
			// handle datatable
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/table-datatables-webspaces_list.js" type="text/javascript"></script>
			';
	}
