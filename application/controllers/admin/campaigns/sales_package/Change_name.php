...
class Change_name extends Admin_Controller {
	...
	public function index($id = '')
	{
		...
		{
			redirect($this->config->slash_item('admin_folder').'campaigns/sales_package/edit/step2/'.$id.'/womens_apparel', 'location');
		}
		else redirect($this->config->slash_item('admin_folder').'campaigns/sales_package/edit/step1/'.$id, 'location');
	}
