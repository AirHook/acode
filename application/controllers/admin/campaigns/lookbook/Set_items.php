	...
	public function index()
	{
		...
		if ( ! empty(@$items_array))
		{
			...
			foreach ($items_array as $item => $options)
			{
				...
				;
				$html.= '<p style="color:white;position:absolute;top:85%;left:5px;font-size:90%;transform-origin: 0 0;transform:rotate(270deg);">'
					.strtoupper($category)
					.'</p>'
				;
				$html.= '<p style="color:white;position:absolute;top:90%;left:10px;font-size:60%;">'
					.$prod_no
					.' &nbsp; &nbsp; '
					.$color_name
					.' &nbsp; &nbsp; '
				...
				$html.= '<img src="'
					...
					.'" style="width:100%;" />'
				;
				$html.= '<p style="color:white;position:absolute;top:90%;right:10px;font-size:60%;">'
					.$i
					.'</p>'
				;
