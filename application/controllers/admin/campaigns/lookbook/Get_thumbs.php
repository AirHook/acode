...
class Get_thumbs extends MY_Controller {
	...
	public function index()
	{
		...
		$admin_user_details = $this->admin_user_details->initialize(
			array(
		...
		if ($admin_user_details->access_level != '0')
		{
		...
		if ($products)
		{
			...
			foreach ($products as $product)
			{
				...
				$html.= '<div style="position:absolute;top:-3px;">';

				if ($product->color_publish == 'N')
				{
					$html.= '<div class="ribbon ribbon-shadow ribbon-round ribbon-border-dash ribbon-vertical-left ribbon-color-info uppercase tooltips" data-placement="top" data-container="body" data-original-title="Private" data-tooltips="tooltips" style="width:25px;padding:1em 0;margin-right:1px;"><i class="fa fa-info-circle"></i></div>';
				}

				if ($product->with_stocks == '0')
				{
					$html.= '<div class="ribbon ribbon-shadow ribbon-round ribbon-border-dash ribbon-vertical-left ribbon-color-danger uppercase tooltips" data-placement="top" data-container="body" data-original-title="Pre Order" data-tooltips="tooltips" style="width:25px;padding:1em 0;;margin-right:1px;"><i class="fa fa-ban"></i></div>';
				}
