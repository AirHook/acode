...
class Index extends Shop_Controller
{
	...
	public function index()
	{
		...
		$this->category_details->initialize(array('category_id' => $this->category_id));
		...
		// this controller renders general categories thumbs page
		if ($this->num <= 1)
		{
			if (
		...
		// get the product list query for use if user clicks on a product
