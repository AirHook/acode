...
class Index extends Admin_Controller {
	...
	public function index()
	{
		...
		// set data variables...
		$this->data['file'] = 'designers';
		$this->data['page_title'] = 'Designers';
		$this->data['page_description'] = 'List of Designers';
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_scripts'] = '';
			...
			// handle datatable
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/table-datatables-designers_list.js" type="text/javascript"></script>
			';
	}
