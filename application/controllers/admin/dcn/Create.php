...
class Create extends Admin_Controller {
	...
	public function index()
	{
		...
		{
			// set data variables...
			$this->data['file'] = 'dcn_page_create';
			$this->data['page_title'] = 'Create A Documentation';
			$this->data['page_description'] = 'A simple way to create a documentation using WYSIWYG';
		...
		else
		{
			...
			$query = $DB->insert('dcn', $post_ary);

			// set flash data
			$this->session->set_flashdata('success', 'add');

			redirect($this->config->slash_item('admin_folder').'dcn/edit/index/'.$DB->insert_id());
		}
	}
