...
class Index extends Admin_Controller {
	 ...
	 * @return	void
	 */
	public function index($designer = '')
	{
		...
		/*
		// default display
		$this->data['active_category_tab'] =
			(
				$this->session->userdata('active_category_tab')
				&& in_array($this->session->userdata('active_category_tab'), $this->designers_list->get())
			)
			? $this->session->userdata('active_category_tab')
			: (
		...
		*/
		...
		else
		{
			...
			else $this->data['categories'] = $this->categories_tree->treelist();
		}

		// set data
		$this->data['d_url_structure'] = $designer ?: 'general_categories';
		$this->data['designers'] = $this->designers_list->select();

		// set data variables...
		$this->data['file'] = 'categories';
		$this->data['page_title'] = 'Categories';
		$this->data['page_description'] = 'Summary of categories';
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_scripts'] = '';
			...
			// handle datatable
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/table-datatables-categories.js" type="text/javascript"></script>
			';
	}
