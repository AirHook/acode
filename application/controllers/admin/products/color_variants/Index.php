...
class Index extends Admin_Controller {
	...
	public function index()
	{
		...
		// set data variables...
		$this->data['file'] = 'products_color_variants';
		$this->data['page_title'] = 'Color Variants';
		$this->data['page_description'] = 'List of color variants with color codes for products';
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_scripts'] = '';
			...
			// handle datatable
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/table-datatables-products_color_variants.js" type="text/javascript"></script>
			';
	}
