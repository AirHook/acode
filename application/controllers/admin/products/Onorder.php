...
class Onorder extends Admin_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			redirect('admin/products/onorder/index/womens_apparel');
		}
		...
		// set facet property
		$params['facets'] = array('availability'=>'preorder');
	...
	private function _set_pagination($count_all = '', $per_page = '')
	{
		...
		$config['first_url'] = site_url('admin/products/onorder/index/womens_apparel');
