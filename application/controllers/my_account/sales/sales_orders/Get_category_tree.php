...
class Get_category_tree extends MY_Controller {
	...
	public function index()
	{
		...
		if ($this->input->post('slugs_link'))
		{
			...
			//$this->session->set_userdata('sa_slug_segs', $this->input->post('slugs_link'));
		}
		else $slug_segs = array();

		// get the designer slug
		$des_slug =
			$this->session->so_des_slug
			?: (
				$this->session->so_mod_des_slug
		...
		$this->session->set_userdata('so_slug_segs', json_encode($slug_segs));
