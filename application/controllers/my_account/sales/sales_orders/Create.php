...
class Create extends Sales_user_Controller
{
	...
	function index()
	{
		...
		else
		{
			...
			*/
			...
			$post_ary['c'] = '2'; // 1-admin,2-sales --> this file is for sales user my account
			$post_ary['user_id'] = $this->session->so_user_id ?: 0; // 0 for manual input
			$post_ary['user_cat'] = $this->session->so_user_cat ?: 0; // 0 for manual input ws/cs
			...
			// redirect user
			redirect('my_account/sales/sales_orders/details/index/'.$this_so_id, 'location');
		}
	}
	...
	private function _create_plugin_scripts()
	{
		...
		$this->data['page_level_scripts'] = '';
			...
			$this->data['page_level_scripts'].= '
				<script src="'.base_url().'assets/custom/js/metronic/pages/scripts/sales-so-components.js" type="text/javascript"></script>
			';
	}
