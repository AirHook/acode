 ...
 *
 */
class Createorder extends Sales_user_Controller
{
	/**
	 * Constructor
	 *
	...
	function index()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->data['company_name'] = isset($this->designer_details->company_name) ?: $this->webspace_details->name;
			$this->data['company_address1'] = isset($this->designer_details->address1) ?: $this->webspace_details->address1;
			$this->data['company_address2'] = isset($this->designer_details->address2) ?: $this->webspace_details->address2;
			$this->data['company_city'] = isset($this->designer_details->city) ?: $this->webspace_details->city;
			$this->data['company_state'] = isset($this->designer_details->state) ?: $this->webspace_details->state;
			$this->data['company_zipcode'] = isset($this->designer_details->zipcode) ?: $this->webspace_details->zipcode;
			$this->data['company_country'] = isset($this->designer_details->country) ?: $this->webspace_details->country;
			$this->data['company_telephone'] = isset($this->designer_details->phone) ?: $this->webspace_details->phone;
			$this->data['company_contact_person'] = isset($this->designer_details->owner) ?: $this->webspace_details->owner;
			$this->data['company_contact_email'] = isset($this->designer_details->info_email) ?: $this->webspace_details->info_email;
