...
class Products extends Sales_user_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			redirect('my_account/sales/products/index/womens_apparel');
		}
	...
	public function not_public()
	{
		...
		{
			// defauls to all dresses under womens apparel
			redirect('my_account/sales/products/not_public/index/womens_apparel');
		}
