...
class Clearance_cs_only extends Sales_user_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			)
			{
				$redirect_url =
					$prev_url_segs
					? 'my_account/sales/products/clearance_cs_only/index'.$prev_url_segs
					: 'my_account/sales/products/clearance_cs_only/index/womens_apparel'
				;
			}
			else
			{
