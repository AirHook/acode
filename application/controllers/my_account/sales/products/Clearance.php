...
class Clearance extends Sales_user_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			)
			{
				$redirect_url =
					$prev_url_segs
					? 'my_account/sales/products/clearance/index'.$prev_url_segs
					: 'my_account/sales/products/clearance/index/womens_apparel'
				;
			}
			else
			{
