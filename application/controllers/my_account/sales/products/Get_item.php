...
class Get_item extends Sales_user_Controller {
	...
	public function index()
	{
		...
		$html.= '<input type="hidden" id="size-select-prod_no" name="prod_no" value="'.$item.'" />';
		$html.= '<input type="hidden" id="size-select-page" name="page" value="create" />';
		...
		$html.= '<div style="margin:10px 0px 30px;">'
			.'<button type="button" class="btn dark btn-block btn-add_to_so"> Add and Create Sales Order </button>'
			.'</div>'
		;
