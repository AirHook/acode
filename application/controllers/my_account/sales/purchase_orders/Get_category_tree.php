...
class Get_category_tree extends Sales_user_Controller {
	...
	public function index()
	{
		...
		// set sessions
		$this->session->set_userdata('po_vendor_id', $vendor_id);
		$this->session->set_userdata('po_des_url_structure', $designer);
		...
		$this->session->set_userdata('po_slug_segs', json_encode($slug_segs));
