...
class Products extends Vendor_user_Controller {
	/**
	 * Constructor
	 *
	 * @return	void
	...
	public function index()
	{
		...
		array_shift($this->data['url_segs']); // vendors
		...
		else
		{
			...
			redirect('my_account/vendors/products/index/womens_apparel');
		}
		...
		$this->data['file'] = '../../my_account/products';
	...
	public function all()
	{
		...
		{
			// defauls to all dresses under womens apparel
			redirect('my_account/vendors/products/all/index/womens_apparel');
		}
	...
	public function is_public()
	{
		...
		{
			// defauls to all dresses under womens apparel
			redirect('my_account/vendors/products/is_public/index/womens_apparel');
		}
	...
	public function not_public()
	{
		...
		{
			// defauls to all dresses under womens apparel
			redirect('my_account/vendors/products/not_public/index/womens_apparel');
		}
	...
	public function unpublished()
	{
		...
		{
			// defauls to all dresses under womens apparel
			redirect('my_account/vendors/products/unpublished/index/womens_apparel');
		}
	...
	public function instock()
	{
		...
		{
			// defauls to all dresses under womens apparel
			redirect('my_account/vendors/products/instock/index/womens_apparel');
		}
	...
	private function _set_pagination($count_all = '', $per_page = '')
	{
		...
		$config['first_url'] = site_url('my_account/vendors/products/all/index/womens_apparel');
