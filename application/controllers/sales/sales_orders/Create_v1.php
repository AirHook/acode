	...
	public function index()
	{
		...
		*/
		...
		else
		{
			...
			// status - 1 - pending, 2 - hold, 3 - return, 4 - intransit, 5 - complete
			$post_ary['status'] = '1';
			...
			*/
			...
			$post_ary['author'] = $post_ary['admin_sales_id'];
			$post_ary['due_date'] = @$post_ary['due_date'] ?: strtotime('+ 1 week');
			$post_ary['remarks'] = @$post_ary['remarks'] ?: '';
			$post_ary['options'] = @$post_ary['options'] ?: '';
