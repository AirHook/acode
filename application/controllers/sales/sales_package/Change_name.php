...
class Change_name extends Sales_Controller {
	...
	public function index($id = '')
	{
		...
		{
			redirect('sales/sales_package/edit/step2/'.$id.'/womens_apparel', 'location');
		}
		else redirect('sales/sales_package/edit/step1/'.$id, 'location');
	}
