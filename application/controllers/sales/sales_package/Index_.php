...
class Index extends Sales_Controller {
	...
	public function index()
	{
		...
		$this->categories_tree->select(
			array(
				'd_url_structure LIKE' => '%'.$this->sales_user_details->designer.'%'
			)
		);
		$this->data['active_category_id'] =
			$this->session->active_category_id
			?: $this->categories_tree->first_row->category_id; // first category on list
		...
		$this->data['page_description'] = ' Select a Sales Package to send';
