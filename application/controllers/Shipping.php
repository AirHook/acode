...
class Shipping extends Frontend_Controller {
	...
	public function index()
	{
		...
		{
			redirect('pages/shipping', 'location');
		}

		if (isset($_SESSION['user_cat']) && $_SESSION['user_cat'] == 'wholesale')
		{
			$page_details = $this->get_pages->page_details('wholesale_shipping');
		}
		else
		{
			$page_details = $this->get_pages->page_details('shipping');
		}
