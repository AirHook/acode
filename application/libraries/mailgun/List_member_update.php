...
class List_member_update {
	...
	public function __construct(array $params = array())
	{
        ...
        log_message('info', 'Mailgun Update List Member Class Loaded');
    }
	...
	public function add()
	{
		...
		// let do the curl
        $csess = curl_init('https://api.mailgun.net/v3/lists/'.$this->list_name.'/members/'.$this->address);
		...
		if ($results['message'] == 'Mailing list member has been updated')
		{
