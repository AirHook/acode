var TableDatatablesManaged = function () {
    ...
    var initTableVendorTypes = function () {

        var table = $('#tbl-vendor_types');
        ...
        var tableWrapper = jQuery('#tbl-vendor_types_wrapper');
    ...
    var autoFill = function () {
		...
		$('.vendor_type').keyup(function(){
			...
			text = text.split('\'').join('');
			text = text.split('"').join('');
			$('.vendor_slug').val(text);
		});
		$('.vendor_type').blur(function(){
			text = this.value;
			text = text.toLowerCase();
			text = text.split('/').join('-');
			text = text.split(' ').join('_');
    ...
    var otherScripts = function () {
		...
		//disable readonly attribute for input element for manual edit
