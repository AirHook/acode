var TableDatatablesManaged = function () {
	...
	$('.filter_by_designer_select').on('change', function(){
		...
		if (!des_slug) {
            ...
            $('#loading').modal('show');
            if (des_slug=='all'){
                window.location.href = base_url + "my_account/sales/orders/" + status + "/index/" + page_param + ".html" + qDates1;
            }else{
                window.location.href = base_url + "my_account/sales/orders/" + status + "/index/" + page_param + "/" + des_slug + ".html" + qDates1;
            }
		}
	});
    ...
    $('.filter_by_listing_select').on('change', function(){
        ...
        if (page_param) {
            ...
            if (des_slug=='all'){
                if (page_param=='all'){
                    window.location.href = base_url + "my_account/sales/orders/" + status + ".html" + qDates2;
                }else{
                    window.location.href = base_url + "my_account/sales/orders/" + status + "/index/" + page_param + ".html" + qDates2;
                }
            }else{
                window.location.href = base_url + "my_account/sales/orders/" + status + "/index/" + page_param + "/" + des_slug + ".html" + qDates2;
            }
        }
	});
    ...
    function setDateRange(qDates){
        ...
        if (des_slug=='all'){
            if (page_param=='all'){
                window.location.href = base_url + "my_account/sales/orders/" + status + ".html" + qDates;
            }else{
                window.location.href = base_url + "my_account/sales/orders/" + status + "/index/" + page_param + ".html" + qDates;
            }
        }else{
            window.location.href = base_url + "my_account/sales/orders/" + status + "/index/" + page_param + "/" + des_slug + ".html" + qDates;
        }
    };
