var ComponentsEditors = function () {
    ...
    var handleScripts = function () {
        ...
        function getPreset(objectData){
            var get_preset = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/get_preset.html",
                data:    objectData
            });
        ...
        function loadPreset(objectData){
            var load_preset = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/load_preset.html",
                data:    objectData,
                dataType: 'json'
            });
        ...
        function getCategoryTree(objectData){
            var get_category_tree = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/get_category_tree.html",
                data:    objectData
            });
        ...
        function getThumbs(objectData){
            var get_thumbs = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/get_thumbs.html",
                data:    objectData
            });
        ...
        function setInfo(objectData){
            var set_info = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/set_info.html",
                data:    objectData
            });
        ...
        function setOptions(objectData){
            var set_options = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/set_options.html",
                data:    objectData
            });
        ...
        function addRemItem(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/addrem.html",
                data:    objectData
            });
        ...
        function setItems(objectData){
            var set_size_qty = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/set_items.html",
                data:    objectData
            });
        ...
        $('#sa-multi-search-form').on('submit', function(e){
            ...
            var search_for_thumbs = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_package/search_multiple.html",
                data:    objectData
            });
