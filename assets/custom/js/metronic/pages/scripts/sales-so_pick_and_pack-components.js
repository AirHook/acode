    ...
    var pageScripts = function () {
		...
		function pickOut(el,objectData){
			...
			var pick_and_pack_udpate = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/pick_and_pack_update.html",
                data:    objectData
            });
		...
		$('.update-so-mod').on('click', function(){
			...
			var update_so = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/pick_and_pack_mod_update.html",
                data:    objectData
            });
			update_so.done(function(data) {
				...
				if (data == 'success') {
					...
					location.href=base_url + 'my_account/sales/sales_orders/details/index/'+objectData.so_id+'.html';
				}else{
