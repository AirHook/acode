var ComponentsEditors = function () {
    ...
    var handleScripts = function () {
        ...
        function getPreset(objectData){
            var get_preset = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/get_preset.html",
                data:    objectData
            });
        ...
        function loadPreset(objectData){
            var load_preset = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/load_preset.html",
                data:    objectData,
                dataType: 'json'
            });
            load_preset.done(function(data){
                $('[name="photo_package_name"]').val(data.photo_package_name);
        ...
        function getCategoryTree(objectData){
            var get_category_tree = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/get_category_tree.html",
                data:    objectData
            });
        ...
        function getThumbs(objectData){
            var get_thumbs = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/get_thumbs.html",
                data:    objectData
            });
        ...
        function setInfo(objectData){
            var set_info = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/set_info.html",
                data:    objectData
            });
        ...
        function setOptions(objectData){
            var set_options = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/set_options.html",
                data:    objectData
            });
        ...
        function getItem(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/get_item.html",
                data:    objectData
            });
        ...
        function addRemItem(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/addrem.html",
                data:    objectData
            });
            addrem.done(function(data) {
                // check/uncheck thumb
        ...
        function submitNewPrice(objectData){
            var set_options = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/set_item_new_price.html",
                data:    objectData
            });
            set_options.done(function(data){
        ...
        function setItems(objectData){
            var set_size_qty = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/set_items.html",
                data:    objectData
            });
        ...
        $('[name="des_slug"]').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
            ...
            $.get(base_url + "my_account/sales/photo_package/set_des_slug_session/index/" + objectData.des_slug + ".html");
        ...
        $('#form-add_unlisted_style_no').on('submit', function(e){
            ...
            objectData.page = $(this).find('[name="page"]').val();
            objectData.action = 'add_item';
            // add/rem item...
        ...
        $('#sa-multi-search-form').on('submit', function(e){
            ...
            var search_for_thumbs = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/photo_package/search_multiple.html",
                data:    objectData
            });
