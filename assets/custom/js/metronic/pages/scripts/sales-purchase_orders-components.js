var ComponentsEditors = function () {
    ...
    var handleScripts = function () {
        ...
        $('.step1-select-vendor, .step2-select-vendor').on('change', function(){
        ...
        $('.thumb-tiles').on('click', '.package_items', function() {
            ...
            $.ajax({
                type:    "POST",
                url:     base_url + "sales/purchase_orders/addrem.html",
                data:    objectData,
                success: function(data) {
                    ...
                    if (data > 0) {
                        ...
                        $('.sidebar_cart_link').attr('href', base_url + 'sales/purchase_orders/create/step3.html');
                        $('.sidebar-send-package-btn').attr('href', base_url + 'sales/purchase_orders/create/step3.html');
        ...
        $('.size-select').on('change', function(){
            ...
            $.ajax({
                type:    "POST",
                url:     base_url + "sales/purchase_orders/set_size_qty.html",
                data:    objectData,
                success: function(data) {
        ...
        $('.edit_vendor_prices').on('click', function(){
            ...
            $.ajax({
                type:    "POST",
                url:     base_url + "sales/purchase_orders/edit_vendor_price.html",
                data:    objectData,
                success: function(data) {
        ...
        $('.submit-po_summary_review_').on('click', function(){
            $('#form-po_summary_review').submit();
        });
        ...
        $('.confirm-clear_all_items').click(function(){
            ...
            $.get(base_url + "sales/purchase_orders/clear_all_items.html", function(data){
                var step = $('.clear_all_items').data('step');
                if (data == 'clear' && step == 4) {
                    window.location.href=base_url + "sales/purchase_orders/create/step3.html";
                }
    ...
    var handleBootbox = function() {
        $('.step.step4, .sidebar-send-po-btn, .submit-po_summary_review').on('click', function(){
            if ($('.overall-qty').html() == 0) {
                alert('Please select quantity for any size required.');
                return false;
            }
            if ($(this).hasClass('mt-bootbox-new')) {
                bootbox.dialog({
                    message: "Sending purchase order. Please confirm...<br />This sends an email to vendor.<br />A copy will also be sent to you.",
                    title: "Notice",
                    buttons: {
