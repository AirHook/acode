var TableDatatablesManaged = function () {
    ...
    var initTableSalesPackages = function () {
        ...
        var tableWrapper = jQuery('#tbl-lookbook_wrapper');
	...
	$('#apply_bulk_actions').click(function(){
		...
		if (!z) {
            ...
            if (z == 'send_to_current_user' || z == 'send_to_new_user') {
                if ($('#tbl-lookbook tbody tr .checkboxes:checked').length > 1) {
    ...
    $('.list-edit-sales-package, .list-create-sales-package').on('click', function(){
        ...
        if (items_count != '0') {
            ...
            $('#modal-items_on_cart .continue-items_on_cart').click(function(){
                ...
                $.get(base_url + "sales/lookbook/clear_all_items.html", function(data){
	...
	$('.apply_filer_by_designer').click(function(){
		...
		if (!z) {
            ...
            $('#loading').modal('show');
            if (z=='all'){
                window.location.href = base_url + "admin/campaigns/lookbook.html";
            }else{
                window.location.href = base_url + "admin/campaigns/lookbook/index/index/" + z + ".html";
            }
		}
	});
