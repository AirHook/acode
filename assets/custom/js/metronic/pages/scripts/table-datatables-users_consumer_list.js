var TableDatatablesManaged = function () {
    ...
    var initTable = function () {
        ...
        var tableWrapper = jQuery('#tbl-consumer_users_wrapper');
	...
	$('.apply_filer_by_designer').click(function(){
		...
		if (!z) {
            ...
            $('#loading').modal('show');
            if (z=='all'){
                window.location.href = base_url + "admin/users/consumer/" + page_param + ".html";
            }else{
                window.location.href = base_url + "admin/users/consumer/" + page_param + "/index/" + z + ".html";
            }
		}
	});
