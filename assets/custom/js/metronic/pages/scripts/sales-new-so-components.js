    ...
    var handleScripts = function () {
        ...
        function getStoreDetails(objectData){
            var get_store_details = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/get_store_details.html",
                data:    objectData
            });
        ...
        function getCategoryTree(objectData){
            var get_category_tree = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/get_category_tree.html",
                data:    objectData
            });
        ...
        function getThumbs(objectData){
            var get_thumbs = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/get_thumbs.html",
                data:    objectData
            });
        ...
        function addDiscount(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/add_discount.html",
                data:    objectData
            });
        ...
        function editQuantity(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/edit_quantity.html",
                data:    objectData
            });
            addrem.done(function(data) {
                // make discount input field empty
        ...
        function getItem(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/get_item.html",
                data:    objectData
            });
            addrem.done(function(data) {
                // fill in modal
        ...
        function addRemItem(objectData){
            var addrem = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/addrem_item.html",
                data:    objectData
            });
            addrem.done(function(data) {
                // check thumb
        ...
        function setItems(){
            var set_size_qty = $.ajax({
                type:    "GET",
                url:     base_url + "my_account/sales/sales_orders/set_items.html"
                //data:    objectData
            });
        ...
        $('[name="des_slug"]').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
            ...
            // set so_des_slug session variable
            $.get(base_url + "my_account/sales/sales_orders/set_des_slug_session/index/" + objectData.des_slug + ".html");
        ...
        $('#so-multi-search-form').on('submit', function(e){
            ...
            var search_for_thumbs = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/search_multiple.html",
                data:    objectData
            });
        ...
        $('[name="delivery_date"]').on('change', function(){
            ...
            var setdd = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/set_dely_date.html",
                data:    objectData
            });
            setdd.done(function(){
                // nothing to do at the moment...
        ...
        $('[name="barcode"]').on('paste', function(e){
            ...
            var verifyBarcode = $.ajax({
                type:    "POST",
                url:     base_url + "my_account/sales/sales_orders/verify_barcode.html",
                dataType: 'json',
                data:    objectData
            });
            verifyBarcode.done(function(data) {
                ...
                if (data.status == 'false'){
                    ...
                    if (data.des_slug) {
                        ...
                        $.ajax({
                            type:    "POST",
                            url:     base_url + "my_account/sales/sales_orders/get_vendors_list.html",
                            data:    objectData,
                        ...
                        $.ajax({
                            type:    "POST",
                            url:     base_url + "my_account/sales/sales_orders/get_stores_list.html",
                            data:    objectData,
                            success: function(data) {
		...
		form1.validate({
            ...
            */
			...
			submitHandler: function (form) {
                ...
                var get_store_details = $.ajax({
                    type:    "POST",
                    url:     base_url + "my_account/sales/sales_orders/add_new_user.html",
                    data:    objectData
                });
                get_store_details.done(function(data) {
                    $('.customer-billing-address').hide();
    ...
    var handleValidation3 = function() {
		...
		form1.validate({
			...
			messages: {
                ...
                //'shipmethod': 'Please select shipping method for this order.'
			},
            // */
